/* file "HomeAutomationSpecifierJSON.h" */

/* Generated automatically by Classy JSON. */


#ifndef HOMEAUTOMATIONSPECIFIERJSON_H
#define HOMEAUTOMATIONSPECIFIERJSON_H
...
class HomeAutomationSpecifierJSON : public ReferenceCounted
  {
  public:
  ...
  private:
    ...
    HomeAutomationSpecifierJSON(const HomeAutomationSpecifierJSON &);
    HomeAutomationSpecifierJSON & operator=(const HomeAutomationSpecifierJSON &other);

    void  fromJSONValue(JSONValue *json_value, bool ignore_extras = false);


  public:
    HomeAutomationSpecifierJSON(void);
    HomeAutomationSpecifierJSON(TypeValue init_value);
    HomeAutomationSpecifierJSON(const char *init_value);
    HomeAutomationSpecifierJSON(std::string init_value);
    HomeAutomationSpecifierJSON(TypeValueKnownValues init_value);
    virtual ~HomeAutomationSpecifierJSON(void);
    ...
    static HomeAutomationSpecifierJSON *from_json(JSONValue *json_value, bool ignore_extras = false);
    static HomeAutomationSpecifierJSON *from_text(const char *text, bool ignore_extras = false)
      {
        HomeAutomationSpecifierJSON *result;
          {
            ...
            parse_json_value(text, "Text for HomeAutomationSpecifierJSON", &generator);
    ...
    static HomeAutomationSpecifierJSON *from_file(FILE *fp, const char *file_name, bool ignore_extras = false)
      {
        HomeAutomationSpecifierJSON *result;
          {
            JSONHoldingGenerator<Generator, RCHandle<HomeAutomationSpecifierJSON>, HomeAutomationSpecifierJSON *, bool> generator("Type HomeAutomationSpecifier", ignore_extras);
    ...
    class Generator : public FieldGeneratorValue
      ...
      protected:
        ...
        virtual void handle_result(HomeAutomationSpecifierJSON *new_result) = 0;
...
#endif /* HOMEAUTOMATIONSPECIFIERJSON_H */
