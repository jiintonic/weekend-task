/* file "BattleshipInvalidCoordinatesCommandJSON.h" */

/* Generated automatically by Classy JSON. */


#ifndef BATTLESHIPINVALIDCOORDINATESCOMMANDJSON_H
#define BATTLESHIPINVALIDCOORDINATESCOMMANDJSON_H
...
class BattleshipInvalidCoordinatesCommandJSON : public BattleshipCommandJSON
  {
  private:
    ...
    BattleshipInvalidCoordinatesCommandJSON(const BattleshipInvalidCoordinatesCommandJSON &);
    BattleshipInvalidCoordinatesCommandJSON & operator=(const BattleshipInvalidCoordinatesCommandJSON &other);
  ...
  public:
    BattleshipInvalidCoordinatesCommandJSON(void);
    virtual ~BattleshipInvalidCoordinatesCommandJSON(void);
    ...
    virtual size_t extraBattleshipInvalidCoordinatesCommandComponentCount(void) const
      {
        assert(extraKeys.size() == extraValues.size());
        return extraKeys.size();
      }
    virtual const char *extraBattleshipInvalidCoordinatesCommandComponentKey(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraKeys[component_num].c_str();
      }
    virtual JSONValue *extraBattleshipInvalidCoordinatesCommandComponentValue(size_t component_num)
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual const JSONValue *extraBattleshipInvalidCoordinatesCommandComponentValue(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual JSONValue *extraBattleshipInvalidCoordinatesCommandLookup(const char *field_name)
      {
    ...
    virtual const JSONValue *extraBattleshipInvalidCoordinatesCommandLookup(const char *field_name) const
      {
        JSONValue *result = (JSONValue *)(lookup_in_string_index(extraIndex, field_name));
        if (result != NULL)
            result->add_reference();
    ...
    virtual void extraBattleshipInvalidCoordinatesCommandAppendPair(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
    ...
    virtual void extraBattleshipInvalidCoordinatesCommandSetField(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
        assert(new_component != NULL);
    ...
    static BattleshipInvalidCoordinatesCommandJSON *from_json(JSONValue *json_value, bool ignore_extras = false);
    static BattleshipInvalidCoordinatesCommandJSON *from_text(const char *text, bool ignore_extras = false)
      {
        BattleshipInvalidCoordinatesCommandJSON *result;
          {
            JSONHoldingGenerator<Generator, RCHandle<BattleshipInvalidCoordinatesCommandJSON>, BattleshipInvalidCoordinatesCommandJSON *, bool> generator("Type BattleshipInvalidCoordinatesCommand", ignore_extras);
            parse_json_value(text, "Text for BattleshipInvalidCoordinatesCommandJSON", &generator);
    ...
    static BattleshipInvalidCoordinatesCommandJSON *from_file(FILE *fp, const char *file_name, bool ignore_extras = false)
      {
        BattleshipInvalidCoordinatesCommandJSON *result;
          {
            JSONHoldingGenerator<Generator, RCHandle<BattleshipInvalidCoordinatesCommandJSON>, BattleshipInvalidCoordinatesCommandJSON *, bool> generator("Type BattleshipInvalidCoordinatesCommand", ignore_extras);
    ...
    class Generator : public BattleshipCommandJSON::Generator
      ...
      protected:
        ...
        void finish(void)
          {
            if (!(strcmp(getBattleshipCommandJSONKey().c_str(), "BattleshipInvalidCoordinatesCommand") == 0))
                throw("The key field has a value other than `BattleshipInvalidCoordinatesCommand'.");
            BattleshipInvalidCoordinatesCommandJSON *result = new BattleshipInvalidCoordinatesCommandJSON();
            assert(result != NULL);
            RCHandle<BattleshipInvalidCoordinatesCommandJSON> result_holder = result;
            finish(result);
            size_t extra_count = unknownFieldGenerator.field_names.size();
            assert(extra_count == unknownFieldGenerator.field_values.size());
            for (size_t extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result->extraBattleshipInvalidCoordinatesCommandAppendPair(unknownFieldGenerator.field_names[extra_num].c_str(), unknownFieldGenerator.field_values[extra_num].referenced());
              }
        ...
        void finish(BattleshipInvalidCoordinatesCommandJSON *result)
          {
        ...
        virtual void handle_result(BattleshipInvalidCoordinatesCommandJSON *new_result) = 0;
      ...
      public:
        Generator(bool ignore_extras = false) : BattleshipCommandJSON::Generator(ignore_extras), fieldGeneratorUserData("field \"UserData\" of the BattleshipInvalidCoordinatesCommand class", ignore_extras), fieldGeneratorComputerData("field \"ComputerData\" of the BattleshipInvalidCoordinatesCommand class", ignore_extras), fieldGeneratorStartDateAndOrTime("field \"StartDateAndOrTime\" of the BattleshipInvalidCoordinatesCommand class", ignore_extras), unknownFieldGenerator(ignore_extras)
          {
...
#endif /* BATTLESHIPINVALIDCOORDINATESCOMMANDJSON_H */
