/* file "SMSDisambiguateChoiceNotUnderstoodCommandJSON.h" */

/* Generated automatically by Classy JSON. */


#ifndef SMSDISAMBIGUATECHOICENOTUNDERSTOODCOMMANDJSON_H
#define SMSDISAMBIGUATECHOICENOTUNDERSTOODCOMMANDJSON_H
...
class SMSDisambiguateChoiceNotUnderstoodCommandJSON : public ClientRepeatCommandJSON
  {
  public:
  ...
  private:
    ...
    SMSDisambiguateChoiceNotUnderstoodCommandJSON(const SMSDisambiguateChoiceNotUnderstoodCommandJSON &);
    SMSDisambiguateChoiceNotUnderstoodCommandJSON & operator=(const SMSDisambiguateChoiceNotUnderstoodCommandJSON &other);
  ...
  public:
    SMSDisambiguateChoiceNotUnderstoodCommandJSON(void);
    virtual ~SMSDisambiguateChoiceNotUnderstoodCommandJSON(void);
    bool  hasNativeData(void) const;
    TypeNativeDataJSON *  getNativeData(void);
    const TypeNativeDataJSON *  getNativeData(void) const;

    virtual size_t extraSMSDisambiguateChoiceNotUnderstoodCommandComponentCount(void) const
      {
        assert(extraKeys.size() == extraValues.size());
        return extraKeys.size();
      }
    virtual const char *extraSMSDisambiguateChoiceNotUnderstoodCommandComponentKey(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraKeys[component_num].c_str();
      }
    virtual JSONValue *extraSMSDisambiguateChoiceNotUnderstoodCommandComponentValue(size_t component_num)
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual const JSONValue *extraSMSDisambiguateChoiceNotUnderstoodCommandComponentValue(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual JSONValue *extraSMSDisambiguateChoiceNotUnderstoodCommandLookup(const char *field_name)
      {
        JSONValue *result = (JSONValue *)(lookup_in_string_index(extraIndex, field_name));
        if (result != NULL)
            result->add_reference();
    ...
    virtual const JSONValue *extraSMSDisambiguateChoiceNotUnderstoodCommandLookup(const char *field_name) const
      {
        JSONValue *result = (JSONValue *)(lookup_in_string_index(extraIndex, field_name));
        if (result != NULL)
            result->add_reference();
    ...
    virtual void extraSMSDisambiguateChoiceNotUnderstoodCommandAppendPair(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
        assert(new_component != NULL);
    ...
    virtual void extraSMSDisambiguateChoiceNotUnderstoodCommandSetField(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
        assert(new_component != NULL);
    ...
    static SMSDisambiguateChoiceNotUnderstoodCommandJSON *from_json(JSONValue *json_value, bool ignore_extras = false);
    static SMSDisambiguateChoiceNotUnderstoodCommandJSON *from_text(const char *text, bool ignore_extras = false)
      {
        SMSDisambiguateChoiceNotUnderstoodCommandJSON *result;
          {
            ...
            parse_json_value(text, "Text for SMSDisambiguateChoiceNotUnderstoodCommandJSON", &generator);
            assert(generator.have_value);
            result = generator.value.referenced();
            result->add_reference();
          };
    ...
    static SMSDisambiguateChoiceNotUnderstoodCommandJSON *from_file(FILE *fp, const char *file_name, bool ignore_extras = false)
      {
        SMSDisambiguateChoiceNotUnderstoodCommandJSON *result;
          {
            JSONHoldingGenerator<Generator, RCHandle<SMSDisambiguateChoiceNotUnderstoodCommandJSON>, SMSDisambiguateChoiceNotUnderstoodCommandJSON *, bool> generator("Type SMSDisambiguateChoiceNotUnderstoodCommand", ignore_extras);
    ...
    class Generator : public ClientRepeatCommandJSON::Generator
      ...
      protected:
        ...
        void finish(void)
          {
            ...
            assert(result != NULL);
            RCHandle<SMSDisambiguateChoiceNotUnderstoodCommandJSON> result_holder = result;
            finish(result);
            size_t extra_count = unknownFieldGenerator.field_names.size();
            assert(extra_count == unknownFieldGenerator.field_values.size());
            for (size_t extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result->extraSMSDisambiguateChoiceNotUnderstoodCommandAppendPair(unknownFieldGenerator.field_names[extra_num].c_str(), unknownFieldGenerator.field_values[extra_num].referenced());
              }
            unknownFieldGenerator.field_names.clear();
            unknownFieldGenerator.field_values.clear();
            destroy_string_index(unknownFieldGenerator.index);
        ...
        void finish(SMSDisambiguateChoiceNotUnderstoodCommandJSON *result)
          {
        ...
        virtual void handle_result(SMSDisambiguateChoiceNotUnderstoodCommandJSON *new_result) = 0;
        virtual JSONHandler *start_known_field(const char *field_name)
          {
            if (strcmp(field_name, "NativeData") == 0)
      ...
      public:
        Generator(bool ignore_extras = false) : ClientRepeatCommandJSON::Generator(ignore_extras), fieldGeneratorNativeData("field \"NativeData\" of the SMSDisambiguateChoiceNotUnderstoodCommand class", ignore_extras), unknownFieldGenerator(ignore_extras)
          {
    ...
    static SMSDisambiguateChoiceNotUnderstoodCommandJSON *from_ClientRepeatCommandJSON_json(const ClientRepeatCommandJSON * ancestor, bool ignore_extras = false)
      {
        assert(ancestor != NULL);
        SMSDisambiguateChoiceNotUnderstoodCommandJSON * result;
          {
            JSONHoldingGenerator<Generator, RCHandle<SMSDisambiguateChoiceNotUnderstoodCommandJSON>, SMSDisambiguateChoiceNotUnderstoodCommandJSON *, bool> handler("Type SMSDisambiguateChoiceNotUnderstoodCommand", ignore_extras);
...
#endif /* SMSDISAMBIGUATECHOICENOTUNDERSTOODCOMMANDJSON_H */
