/* file "RadioControlOtherFMBandsJSON.h" */

/* Generated automatically by Classy JSON. */


#ifndef RADIOCONTROLOTHERFMBANDSJSON_H
#define RADIOCONTROLOTHERFMBANDSJSON_H
...
class RadioControlOtherFMBandsJSON : public ReferenceCounted
  {
  public:
        ...
        void setMinimum(double new_value)
          {
            flagHasMinimum = true;
            if (new_value < 65.8)
                throw("The value for field Minimum of TypeValueJSON is less than the lower bound (65.8) for that field.");
            if (new_value > 108)
                throw("The value for field Minimum of TypeValueJSON is greater than the upper bound (108) for that field.");
        ...
        void setMaximum(double new_value)
          {
            flagHasMaximum = true;
            if (new_value < 65.8)
                throw("The value for field Maximum of TypeValueJSON is less than the lower bound (65.8) for that field.");
            if (new_value > 108)
                throw("The value for field Maximum of TypeValueJSON is greater than the upper bound (108) for that field.");
        ...
        void setStep(double new_value)
          {
            flagHasStep = true;
            if (new_value < 0.001)
                throw("The value for field Step of TypeValueJSON is less than the lower bound (0.001) for that field.");
            if (new_value > 1)
                throw("The value for field Step of TypeValueJSON is greater than the upper bound (1) for that field.");
            storeStep = new_value;
            textStoreStep = "";
          }
        void setStepText(std::string new_value)
          {
            ...
            if (JSONWriter::compare_number_text_to_repeating_fraction(new_value.c_str(), false, "1", "", true, "2") < 0)
                throw("The value for field Step of TypeValueJSON is less than the lower bound (0.001) for that field.");
  ...
  private:
    ...
    RadioControlOtherFMBandsJSON(const RadioControlOtherFMBandsJSON &);
    RadioControlOtherFMBandsJSON & operator=(const RadioControlOtherFMBandsJSON &other);

    void  fromJSONValue(JSONValue *json_value, bool ignore_extras = false);


  public:
    RadioControlOtherFMBandsJSON(void);
    virtual ~RadioControlOtherFMBandsJSON(void);
    ...
    static RadioControlOtherFMBandsJSON *from_json(JSONValue *json_value, bool ignore_extras = false);
    static RadioControlOtherFMBandsJSON *from_text(const char *text, bool ignore_extras = false)
      {
        RadioControlOtherFMBandsJSON *result;
          {
            ...
            parse_json_value(text, "Text for RadioControlOtherFMBandsJSON", &generator);
            assert(generator.have_value);
            result = generator.value.referenced();
            result->add_reference();
          };
    ...
    static RadioControlOtherFMBandsJSON *from_file(FILE *fp, const char *file_name, bool ignore_extras = false)
      {
        RadioControlOtherFMBandsJSON *result;
          {
            JSONHoldingGenerator<Generator, RCHandle<RadioControlOtherFMBandsJSON>, RadioControlOtherFMBandsJSON *, bool> generator("Type RadioControlOtherFMBands", ignore_extras);
    ...
    class Generator : public JSONHoldingArrayGenerator<TypeValueJSON::Generator, RCHandle<TypeValueJSON>, TypeValueJSON *, bool >
      ...
      protected:
        ...
        virtual void handle_result(RadioControlOtherFMBandsJSON *new_result) = 0;

      public:
        Generator(bool ignore_extras = false) : JSONHoldingArrayGenerator<TypeValueJSON::Generator, RCHandle<TypeValueJSON>, TypeValueJSON *, bool >("Type RadioControlOtherFMBands", ignore_extras)
          {
          }
        ~Generator(void)  { }
      };
...
#endif /* RADIOCONTROLOTHERFMBANDSJSON_H */
