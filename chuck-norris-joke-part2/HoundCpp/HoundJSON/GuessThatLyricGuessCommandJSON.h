/* file "GuessThatLyricGuessCommandJSON.h" */

/* Generated automatically by Classy JSON. */


#ifndef GUESSTHATLYRICGUESSCOMMANDJSON_H
#define GUESSTHATLYRICGUESSCOMMANDJSON_H
...
class GuessThatLyricGuessCommandJSON : public GuessThatLyricCommandJSON
  {
  private:
    bool flagHasDecade;
    ...
    GuessThatLyricGuessCommandJSON(const GuessThatLyricGuessCommandJSON &);
    GuessThatLyricGuessCommandJSON & operator=(const GuessThatLyricGuessCommandJSON &other);
  ...
  public:
    GuessThatLyricGuessCommandJSON(void);
    virtual ~GuessThatLyricGuessCommandJSON(void);
    ...
    virtual size_t extraGuessThatLyricGuessCommandComponentCount(void) const
      {
        assert(extraKeys.size() == extraValues.size());
        return extraKeys.size();
      }
    virtual const char *extraGuessThatLyricGuessCommandComponentKey(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraKeys[component_num].c_str();
      }
    virtual JSONValue *extraGuessThatLyricGuessCommandComponentValue(size_t component_num)
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual const JSONValue *extraGuessThatLyricGuessCommandComponentValue(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual JSONValue *extraGuessThatLyricGuessCommandLookup(const char *field_name)
      {
    ...
    virtual const JSONValue *extraGuessThatLyricGuessCommandLookup(const char *field_name) const
      {
        JSONValue *result = (JSONValue *)(lookup_in_string_index(extraIndex, field_name));
        if (result != NULL)
            result->add_reference();
    ...
    void setDecade(OInteger new_value)
      {
        flagHasDecade = true;
        if (new_value < 0)
            throw("The value for field Decade of GuessThatLyricGuessCommandJSON is less than the lower bound (0) for that field.");
    ...
    void setGuessedCorrectly(OInteger new_value)
      {
        ...
        if (new_value < 0)
            throw("The value for field GuessedCorrectly of GuessThatLyricGuessCommandJSON is less than the lower bound (0) for that field.");
    ...
    void setHintsRemaining(uint8_t new_value)
      {
        ...
        if (new_value < 0)
            throw("The value for field HintsRemaining of GuessThatLyricGuessCommandJSON is less than the lower bound (0) for that field.");
        if (new_value > 4)
            throw("The value for field HintsRemaining of GuessThatLyricGuessCommandJSON is greater than the upper bound (4) for that field.");
    ...
    virtual void extraGuessThatLyricGuessCommandAppendPair(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
    ...
    virtual void extraGuessThatLyricGuessCommandSetField(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
        assert(new_component != NULL);
    ...
    static GuessThatLyricGuessCommandJSON *from_json(JSONValue *json_value, bool ignore_extras = false);
    static GuessThatLyricGuessCommandJSON *from_text(const char *text, bool ignore_extras = false)
      {
        GuessThatLyricGuessCommandJSON *result;
          {
            ...
            parse_json_value(text, "Text for GuessThatLyricGuessCommandJSON", &generator);
    ...
    static GuessThatLyricGuessCommandJSON *from_file(FILE *fp, const char *file_name, bool ignore_extras = false)
      {
        GuessThatLyricGuessCommandJSON *result;
          {
            JSONHoldingGenerator<Generator, RCHandle<GuessThatLyricGuessCommandJSON>, GuessThatLyricGuessCommandJSON *, bool> generator("Type GuessThatLyricGuessCommand", ignore_extras);
    ...
    class Generator : public GuessThatLyricCommandJSON::Generator
      ...
      protected:
        ...
        void finish(void)
          {
            if (!(strcmp(getGuessThatLyricCommandJSONKey().c_str(), "GuessThatLyricGuessCommand") == 0))
                throw("The key field has a value other than `GuessThatLyricGuessCommand'.");
            GuessThatLyricGuessCommandJSON *result = new GuessThatLyricGuessCommandJSON();
            assert(result != NULL);
            RCHandle<GuessThatLyricGuessCommandJSON> result_holder = result;
            finish(result);
            size_t extra_count = unknownFieldGenerator.field_names.size();
            assert(extra_count == unknownFieldGenerator.field_values.size());
            for (size_t extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result->extraGuessThatLyricGuessCommandAppendPair(unknownFieldGenerator.field_names[extra_num].c_str(), unknownFieldGenerator.field_values[extra_num].referenced());
              }
        ...
        void finish(GuessThatLyricGuessCommandJSON *result)
          {
        ...
        virtual void handle_result(GuessThatLyricGuessCommandJSON *new_result) = 0;
      ...
      public:
        Generator(bool ignore_extras = false) : GuessThatLyricCommandJSON::Generator(ignore_extras), fieldGeneratorDecade("field \"Decade\" of the GuessThatLyricGuessCommand class"), fieldGeneratorGuessedCorrectly("field \"GuessedCorrectly\" of the GuessThatLyricGuessCommand class"), fieldGeneratorHintsRemaining("field \"HintsRemaining\" of the GuessThatLyricGuessCommand class"), fieldGeneratorDifficulty("field \"Difficulty\" of the GuessThatLyricGuessCommand class"), fieldGeneratorCorrectAnswer("field \"CorrectAnswer\" of the GuessThatLyricGuessCommand class"), fieldGeneratorQuestion("field \"Question\" of the GuessThatLyricGuessCommand class"), fieldGeneratorSoundhoundLyricID("field \"SoundhoundLyricID\" of the GuessThatLyricGuessCommand class"), fieldGeneratorGTLSoundhoundTrackID("field \"GTLSoundhoundTrackID\" of the GuessThatLyricGuessCommand class"), fieldGeneratorCorrectTitle("field \"CorrectTitle\" of the GuessThatLyricGuessCommand class"), fieldGeneratorCorrectArtist("field \"CorrectArtist\" of the GuessThatLyricGuessCommand class"), fieldGeneratorPlayerLost("field \"PlayerLost\" of the GuessThatLyricGuessCommand class"), fieldGeneratorGuessedTracksList("field \"GuessedTracksList\" of the GuessThatLyricGuessCommand class", ignore_extras), unknownFieldGenerator(ignore_extras)
          {
...
#endif /* GUESSTHATLYRICGUESSCOMMANDJSON_H */
