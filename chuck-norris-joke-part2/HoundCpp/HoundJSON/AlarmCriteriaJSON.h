/* file "AlarmCriteriaJSON.h" */

/* Generated automatically by Classy JSON. */


#ifndef ALARMCRITERIAJSON_H
#define ALARMCRITERIAJSON_H
...
class AlarmCriteriaJSON : public ReferenceCounted
  {
  public:
  ...
  private:
    ...
    AlarmCriteriaJSON(const AlarmCriteriaJSON &);
    AlarmCriteriaJSON & operator=(const AlarmCriteriaJSON &other);
  ...
  public:
    AlarmCriteriaJSON(void);
    virtual ~AlarmCriteriaJSON(void);
    ...
    virtual size_t extraAlarmCriteriaComponentCount(void) const
      {
        assert(extraKeys.size() == extraValues.size());
        return extraKeys.size();
      }
    virtual const char *extraAlarmCriteriaComponentKey(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraKeys[component_num].c_str();
      }
    virtual JSONValue *extraAlarmCriteriaComponentValue(size_t component_num)
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual const JSONValue *extraAlarmCriteriaComponentValue(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual JSONValue *extraAlarmCriteriaLookup(const char *field_name)
      {
    ...
    virtual const JSONValue *extraAlarmCriteriaLookup(const char *field_name) const
      {
        JSONValue *result = (JSONValue *)(lookup_in_string_index(extraIndex, field_name));
        if (result != NULL)
            result->add_reference();
    ...
    void setPosition(OInteger new_value)
      {
        ...
        if (new_value < 1)
            throw("The value for field Position of AlarmCriteriaJSON is less than the lower bound (1) for that field.");
    ...
    void setHour(uint8_t new_value)
      {
        flagHasHour = true;
        if (new_value < 0)
            throw("The value for field Hour of AlarmCriteriaJSON is less than the lower bound (0) for that field.");
        if (new_value > 23)
            throw("The value for field Hour of AlarmCriteriaJSON is greater than the upper bound (23) for that field.");
        storeHour = new_value;
      }
    void unsetHour(void)
      {
    ...
    void setMinute(uint8_t new_value)
      {
        flagHasMinute = true;
        if (new_value < 0)
            throw("The value for field Minute of AlarmCriteriaJSON is less than the lower bound (0) for that field.");
        if (new_value > 59)
            throw("The value for field Minute of AlarmCriteriaJSON is greater than the upper bound (59) for that field.");
    ...
    void setSecond(uint8_t new_value)
      {
        flagHasSecond = true;
        if (new_value < 0)
            throw("The value for field Second of AlarmCriteriaJSON is less than the lower bound (0) for that field.");
        if (new_value > 60)
            throw("The value for field Second of AlarmCriteriaJSON is greater than the upper bound (60) for that field.");
    ...
    virtual void extraAlarmCriteriaAppendPair(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
    ...
    virtual void extraAlarmCriteriaSetField(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
        assert(new_component != NULL);
    ...
    static AlarmCriteriaJSON *from_json(JSONValue *json_value, bool ignore_extras = false);
    static AlarmCriteriaJSON *from_text(const char *text, bool ignore_extras = false)
      {
        AlarmCriteriaJSON *result;
          {
            ...
            parse_json_value(text, "Text for AlarmCriteriaJSON", &generator);
    ...
    static AlarmCriteriaJSON *from_file(FILE *fp, const char *file_name, bool ignore_extras = false)
      {
        AlarmCriteriaJSON *result;
          {
            JSONHoldingGenerator<Generator, RCHandle<AlarmCriteriaJSON>, AlarmCriteriaJSON *, bool> generator("Type AlarmCriteria", ignore_extras);
    ...
    class FieldGeneratorDaysOfWeek : public JSONStringGenerator
      ...
      protected:
        ...
        void finish(void)
          {
            ...
            assert(result != NULL);
            RCHandle<AlarmCriteriaJSON> result_holder = result;
            finish(result);
            size_t extra_count = unknownFieldGenerator.field_names.size();
            assert(extra_count == unknownFieldGenerator.field_values.size());
            for (size_t extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result->extraAlarmCriteriaAppendPair(unknownFieldGenerator.field_names[extra_num].c_str(), unknownFieldGenerator.field_values[extra_num].referenced());
              }
        ...
        void finish(AlarmCriteriaJSON *result)
          {
        ...
        virtual void handle_result(AlarmCriteriaJSON *new_result) = 0;
      ...
      public:
        Generator(bool ignore_extras = false) : fieldGeneratorTitle("field \"Title\" of the AlarmCriteria class"), fieldGeneratorPosition("field \"Position\" of the AlarmCriteria class"), fieldGeneratorIsWake("field \"IsWake\" of the AlarmCriteria class"), fieldGeneratorIsRecurring("field \"IsRecurring\" of the AlarmCriteria class"), fieldGeneratorHour("field \"Hour\" of the AlarmCriteria class"), fieldGeneratorMinute("field \"Minute\" of the AlarmCriteria class"), fieldGeneratorSecond("field \"Second\" of the AlarmCriteria class"), fieldGeneratorDaysOfWeek("field \"DaysOfWeek\" of the AlarmCriteria class"), fieldGeneratorInvalidDates("field \"InvalidDates\" of the AlarmCriteria class", ignore_extras), unknownFieldGenerator(ignore_extras)
          {
