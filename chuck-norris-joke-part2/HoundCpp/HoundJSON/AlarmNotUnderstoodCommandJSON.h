/* file "AlarmNotUnderstoodCommandJSON.h" */

/* Generated automatically by Classy JSON. */


#ifndef ALARMNOTUNDERSTOODCOMMANDJSON_H
#define ALARMNOTUNDERSTOODCOMMANDJSON_H
...
class AlarmNotUnderstoodCommandJSON : public AlarmCommandJSON
  {
  private:
    ...
    AlarmNotUnderstoodCommandJSON(const AlarmNotUnderstoodCommandJSON &);
    AlarmNotUnderstoodCommandJSON & operator=(const AlarmNotUnderstoodCommandJSON &other);
  ...
  public:
    AlarmNotUnderstoodCommandJSON(void);
    virtual ~AlarmNotUnderstoodCommandJSON(void);
    ...
    virtual size_t extraAlarmNotUnderstoodCommandComponentCount(void) const
      {
        assert(extraKeys.size() == extraValues.size());
        return extraKeys.size();
      }
    virtual const char *extraAlarmNotUnderstoodCommandComponentKey(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraKeys[component_num].c_str();
      }
    virtual JSONValue *extraAlarmNotUnderstoodCommandComponentValue(size_t component_num)
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual const JSONValue *extraAlarmNotUnderstoodCommandComponentValue(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual JSONValue *extraAlarmNotUnderstoodCommandLookup(const char *field_name)
      {
    ...
    virtual const JSONValue *extraAlarmNotUnderstoodCommandLookup(const char *field_name) const
      {
        JSONValue *result = (JSONValue *)(lookup_in_string_index(extraIndex, field_name));
        if (result != NULL)
            result->add_reference();
    ...
    virtual void extraAlarmNotUnderstoodCommandAppendPair(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
    ...
    virtual void extraAlarmNotUnderstoodCommandSetField(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
        assert(new_component != NULL);
    ...
    static AlarmNotUnderstoodCommandJSON *from_json(JSONValue *json_value, bool ignore_extras = false);
    static AlarmNotUnderstoodCommandJSON *from_text(const char *text, bool ignore_extras = false)
      {
        AlarmNotUnderstoodCommandJSON *result;
          {
            ...
            parse_json_value(text, "Text for AlarmNotUnderstoodCommandJSON", &generator);
    ...
    static AlarmNotUnderstoodCommandJSON *from_file(FILE *fp, const char *file_name, bool ignore_extras = false)
      {
        AlarmNotUnderstoodCommandJSON *result;
          {
            JSONHoldingGenerator<Generator, RCHandle<AlarmNotUnderstoodCommandJSON>, AlarmNotUnderstoodCommandJSON *, bool> generator("Type AlarmNotUnderstoodCommand", ignore_extras);
    ...
    class Generator : public AlarmCommandJSON::Generator
      ...
      protected:
        ...
        void finish(void)
          {
            if (!(strcmp(getAlarmCommandJSONKey().c_str(), "AlarmNotUnderstoodCommand") == 0))
                throw("The key field has a value other than `AlarmNotUnderstoodCommand'.");
            AlarmNotUnderstoodCommandJSON *result = new AlarmNotUnderstoodCommandJSON();
            assert(result != NULL);
            RCHandle<AlarmNotUnderstoodCommandJSON> result_holder = result;
            finish(result);
            size_t extra_count = unknownFieldGenerator.field_names.size();
            assert(extra_count == unknownFieldGenerator.field_values.size());
            for (size_t extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result->extraAlarmNotUnderstoodCommandAppendPair(unknownFieldGenerator.field_names[extra_num].c_str(), unknownFieldGenerator.field_values[extra_num].referenced());
              }
        ...
        void finish(AlarmNotUnderstoodCommandJSON *result)
          {
        ...
        virtual void handle_result(AlarmNotUnderstoodCommandJSON *new_result) = 0;
      ...
      public:
        Generator(bool ignore_extras = false) : AlarmCommandJSON::Generator(ignore_extras), fieldGeneratorNativeData("field \"NativeData\" of the AlarmNotUnderstoodCommand class"), unknownFieldGenerator(ignore_extras)
          {
...
#endif /* ALARMNOTUNDERSTOODCOMMANDJSON_H */
