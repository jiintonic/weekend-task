/* file "GuessThatLyricStartGameCommandJSON.h" */

/* Generated automatically by Classy JSON. */


#ifndef GUESSTHATLYRICSTARTGAMECOMMANDJSON_H
#define GUESSTHATLYRICSTARTGAMECOMMANDJSON_H
...
class GuessThatLyricStartGameCommandJSON : public GuessThatLyricCommandJSON
  {
  private:
    bool flagHasDecade;
    ...
    GuessThatLyricStartGameCommandJSON(const GuessThatLyricStartGameCommandJSON &);
    GuessThatLyricStartGameCommandJSON & operator=(const GuessThatLyricStartGameCommandJSON &other);
  ...
  public:
    GuessThatLyricStartGameCommandJSON(void);
    virtual ~GuessThatLyricStartGameCommandJSON(void);
    ...
    virtual size_t extraGuessThatLyricStartGameCommandComponentCount(void) const
      {
        assert(extraKeys.size() == extraValues.size());
        return extraKeys.size();
      }
    virtual const char *extraGuessThatLyricStartGameCommandComponentKey(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraKeys[component_num].c_str();
      }
    virtual JSONValue *extraGuessThatLyricStartGameCommandComponentValue(size_t component_num)
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual const JSONValue *extraGuessThatLyricStartGameCommandComponentValue(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual JSONValue *extraGuessThatLyricStartGameCommandLookup(const char *field_name)
      {
    ...
    virtual const JSONValue *extraGuessThatLyricStartGameCommandLookup(const char *field_name) const
      {
        JSONValue *result = (JSONValue *)(lookup_in_string_index(extraIndex, field_name));
        if (result != NULL)
            result->add_reference();
    ...
    void setDecade(OInteger new_value)
      {
        flagHasDecade = true;
        if (new_value < 0)
            throw("The value for field Decade of GuessThatLyricStartGameCommandJSON is less than the lower bound (0) for that field.");
    ...
    void setGuessedCorrectly(OInteger new_value)
      {
        ...
        if (new_value < 0)
            throw("The value for field GuessedCorrectly of GuessThatLyricStartGameCommandJSON is less than the lower bound (0) for that field.");
    ...
    void setHintsRemaining(uint8_t new_value)
      {
        ...
        if (new_value < 0)
            throw("The value for field HintsRemaining of GuessThatLyricStartGameCommandJSON is less than the lower bound (0) for that field.");
        if (new_value > 4)
            throw("The value for field HintsRemaining of GuessThatLyricStartGameCommandJSON is greater than the upper bound (4) for that field.");
    ...
    virtual void extraGuessThatLyricStartGameCommandAppendPair(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
    ...
    virtual void extraGuessThatLyricStartGameCommandSetField(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
        assert(new_component != NULL);
    ...
    static GuessThatLyricStartGameCommandJSON *from_json(JSONValue *json_value, bool ignore_extras = false);
    static GuessThatLyricStartGameCommandJSON *from_text(const char *text, bool ignore_extras = false)
      {
        GuessThatLyricStartGameCommandJSON *result;
          {
            ...
            parse_json_value(text, "Text for GuessThatLyricStartGameCommandJSON", &generator);
    ...
    static GuessThatLyricStartGameCommandJSON *from_file(FILE *fp, const char *file_name, bool ignore_extras = false)
      {
        GuessThatLyricStartGameCommandJSON *result;
          {
            JSONHoldingGenerator<Generator, RCHandle<GuessThatLyricStartGameCommandJSON>, GuessThatLyricStartGameCommandJSON *, bool> generator("Type GuessThatLyricStartGameCommand", ignore_extras);
    ...
    class Generator : public GuessThatLyricCommandJSON::Generator
      ...
      protected:
        ...
        void finish(void)
          {
            if (!(strcmp(getGuessThatLyricCommandJSONKey().c_str(), "GuessThatLyricStartGameCommand") == 0))
                throw("The key field has a value other than `GuessThatLyricStartGameCommand'.");
            GuessThatLyricStartGameCommandJSON *result = new GuessThatLyricStartGameCommandJSON();
            assert(result != NULL);
            RCHandle<GuessThatLyricStartGameCommandJSON> result_holder = result;
            finish(result);
            size_t extra_count = unknownFieldGenerator.field_names.size();
            assert(extra_count == unknownFieldGenerator.field_values.size());
            for (size_t extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result->extraGuessThatLyricStartGameCommandAppendPair(unknownFieldGenerator.field_names[extra_num].c_str(), unknownFieldGenerator.field_values[extra_num].referenced());
              }
        ...
        void finish(GuessThatLyricStartGameCommandJSON *result)
          {
        ...
        virtual void handle_result(GuessThatLyricStartGameCommandJSON *new_result) = 0;
      ...
      public:
        Generator(bool ignore_extras = false) : GuessThatLyricCommandJSON::Generator(ignore_extras), fieldGeneratorDecade("field \"Decade\" of the GuessThatLyricStartGameCommand class"), fieldGeneratorGuessedCorrectly("field \"GuessedCorrectly\" of the GuessThatLyricStartGameCommand class"), fieldGeneratorHintsRemaining("field \"HintsRemaining\" of the GuessThatLyricStartGameCommand class"), fieldGeneratorDifficulty("field \"Difficulty\" of the GuessThatLyricStartGameCommand class"), fieldGeneratorCorrectAnswer("field \"CorrectAnswer\" of the GuessThatLyricStartGameCommand class"), fieldGeneratorQuestion("field \"Question\" of the GuessThatLyricStartGameCommand class"), fieldGeneratorSoundhoundLyricID("field \"SoundhoundLyricID\" of the GuessThatLyricStartGameCommand class"), fieldGeneratorGTLSoundhoundTrackID("field \"GTLSoundhoundTrackID\" of the GuessThatLyricStartGameCommand class"), fieldGeneratorCorrectTitle("field \"CorrectTitle\" of the GuessThatLyricStartGameCommand class"), fieldGeneratorCorrectArtist("field \"CorrectArtist\" of the GuessThatLyricStartGameCommand class"), fieldGeneratorPlayerLost("field \"PlayerLost\" of the GuessThatLyricStartGameCommand class"), fieldGeneratorGuessedTracksList("field \"GuessedTracksList\" of the GuessThatLyricStartGameCommand class", ignore_extras), unknownFieldGenerator(ignore_extras)
          {
...
#endif /* GUESSTHATLYRICSTARTGAMECOMMANDJSON_H */
