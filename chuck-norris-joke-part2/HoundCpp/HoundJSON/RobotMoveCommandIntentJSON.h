/* file "RobotMoveCommandIntentJSON.h" */

/* Generated automatically by Classy JSON. */


#ifndef ROBOTMOVECOMMANDINTENTJSON_H
#define ROBOTMOVECOMMANDINTENTJSON_H
...
class RobotMoveCommandIntentJSON : public RobotCommandIntentJSON
  {
  public:
  ...
  private:
    ...
    RobotMoveCommandIntentJSON(const RobotMoveCommandIntentJSON &);
    RobotMoveCommandIntentJSON & operator=(const RobotMoveCommandIntentJSON &other);
  ...
  public:
    RobotMoveCommandIntentJSON(void);
    virtual ~RobotMoveCommandIntentJSON(void);
    ...
    virtual size_t extraRobotMoveCommandIntentComponentCount(void) const
      {
        assert(extraKeys.size() == extraValues.size());
        return extraKeys.size();
      }
    virtual const char *extraRobotMoveCommandIntentComponentKey(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraKeys[component_num].c_str();
      }
    virtual JSONValue *extraRobotMoveCommandIntentComponentValue(size_t component_num)
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual const JSONValue *extraRobotMoveCommandIntentComponentValue(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual JSONValue *extraRobotMoveCommandIntentLookup(const char *field_name)
      {
    ...
    virtual const JSONValue *extraRobotMoveCommandIntentLookup(const char *field_name) const
      {
        JSONValue *result = (JSONValue *)(lookup_in_string_index(extraIndex, field_name));
        if (result != NULL)
            result->add_reference();
    ...
    void setDirection(OInteger new_value)
      {
        ...
        if (new_value < -180)
            throw("The value for field Direction of RobotMoveCommandIntentJSON is less than the lower bound (-180) for that field.");
        if (new_value > 180)
            throw("The value for field Direction of RobotMoveCommandIntentJSON is greater than the upper bound (180) for that field.");
    ...
    void setDistance(double new_value)
      {
        ...
        if (new_value < 0)
            throw("The value for field Distance of RobotMoveCommandIntentJSON is less than the lower bound (0) for that field.");
    ...
    void setDistanceText(std::string new_value)
      {
        ...
        if (!(JSONWriter::is_valid_number_format(new_value.c_str())))
            throw("The text value for field Distance of RobotMoveCommandIntentJSON is not a valid number.");
    ...
    virtual void extraRobotMoveCommandIntentAppendPair(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
    ...
    virtual void extraRobotMoveCommandIntentSetField(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
        assert(new_component != NULL);
    ...
    static RobotMoveCommandIntentJSON *from_json(JSONValue *json_value, bool ignore_extras = false);
    static RobotMoveCommandIntentJSON *from_text(const char *text, bool ignore_extras = false)
      {
        RobotMoveCommandIntentJSON *result;
          {
            ...
            parse_json_value(text, "Text for RobotMoveCommandIntentJSON", &generator);
    ...
    static RobotMoveCommandIntentJSON *from_file(FILE *fp, const char *file_name, bool ignore_extras = false)
      {
        RobotMoveCommandIntentJSON *result;
          {
            JSONHoldingGenerator<Generator, RCHandle<RobotMoveCommandIntentJSON>, RobotMoveCommandIntentJSON *, bool> generator("Type RobotMoveCommandIntent", ignore_extras);
    ...
    class FieldGeneratorDistanceUnit : public JSONStringGenerator
      ...
      protected:
        ...
        void finish(void)
          {
            if (!(strcmp(getRobotCommandIntentJSONKey().c_str(), "MoveCommand") == 0))
                throw("The key field has a value other than `MoveCommand'.");
            RobotMoveCommandIntentJSON *result = new RobotMoveCommandIntentJSON();
            assert(result != NULL);
            RCHandle<RobotMoveCommandIntentJSON> result_holder = result;
            finish(result);
            size_t extra_count = unknownFieldGenerator.field_names.size();
            assert(extra_count == unknownFieldGenerator.field_values.size());
            for (size_t extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result->extraRobotMoveCommandIntentAppendPair(unknownFieldGenerator.field_names[extra_num].c_str(), unknownFieldGenerator.field_values[extra_num].referenced());
              }
        ...
        void finish(RobotMoveCommandIntentJSON *result)
          {
        ...
        virtual void handle_result(RobotMoveCommandIntentJSON *new_result) = 0;
      ...
      public:
        Generator(bool ignore_extras = false) : RobotCommandIntentJSON::Generator(ignore_extras), fieldGeneratorDirection("field \"Direction\" of the RobotMoveCommandIntent class"), fieldGeneratorDistance("field \"Distance\" of the RobotMoveCommandIntent class"), fieldGeneratorDistanceUnit("field \"DistanceUnit\" of the RobotMoveCommandIntent class"), unknownFieldGenerator(ignore_extras)
          {
...
#endif /* ROBOTMOVECOMMANDINTENTJSON_H */
