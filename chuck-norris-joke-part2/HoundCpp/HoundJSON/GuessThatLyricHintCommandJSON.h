/* file "GuessThatLyricHintCommandJSON.h" */

/* Generated automatically by Classy JSON. */


#ifndef GUESSTHATLYRICHINTCOMMANDJSON_H
#define GUESSTHATLYRICHINTCOMMANDJSON_H
...
class GuessThatLyricHintCommandJSON : public GuessThatLyricCommandJSON
  {
  private:
    bool flagHasDecade;
    ...
    GuessThatLyricHintCommandJSON(const GuessThatLyricHintCommandJSON &);
    GuessThatLyricHintCommandJSON & operator=(const GuessThatLyricHintCommandJSON &other);
  ...
  public:
    GuessThatLyricHintCommandJSON(void);
    virtual ~GuessThatLyricHintCommandJSON(void);
    ...
    virtual size_t extraGuessThatLyricHintCommandComponentCount(void) const
      {
        assert(extraKeys.size() == extraValues.size());
        return extraKeys.size();
      }
    virtual const char *extraGuessThatLyricHintCommandComponentKey(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraKeys[component_num].c_str();
      }
    virtual JSONValue *extraGuessThatLyricHintCommandComponentValue(size_t component_num)
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual const JSONValue *extraGuessThatLyricHintCommandComponentValue(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual JSONValue *extraGuessThatLyricHintCommandLookup(const char *field_name)
      {
    ...
    virtual const JSONValue *extraGuessThatLyricHintCommandLookup(const char *field_name) const
      {
        JSONValue *result = (JSONValue *)(lookup_in_string_index(extraIndex, field_name));
        if (result != NULL)
            result->add_reference();
    ...
    void setDecade(OInteger new_value)
      {
        flagHasDecade = true;
        if (new_value < 0)
            throw("The value for field Decade of GuessThatLyricHintCommandJSON is less than the lower bound (0) for that field.");
    ...
    void setGuessedCorrectly(OInteger new_value)
      {
        ...
        if (new_value < 0)
            throw("The value for field GuessedCorrectly of GuessThatLyricHintCommandJSON is less than the lower bound (0) for that field.");
    ...
    void setHintsRemaining(uint8_t new_value)
      {
        ...
        if (new_value < 0)
            throw("The value for field HintsRemaining of GuessThatLyricHintCommandJSON is less than the lower bound (0) for that field.");
        if (new_value > 4)
            throw("The value for field HintsRemaining of GuessThatLyricHintCommandJSON is greater than the upper bound (4) for that field.");
    ...
    virtual void extraGuessThatLyricHintCommandAppendPair(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
    ...
    virtual void extraGuessThatLyricHintCommandSetField(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
        assert(new_component != NULL);
    ...
    static GuessThatLyricHintCommandJSON *from_json(JSONValue *json_value, bool ignore_extras = false);
    static GuessThatLyricHintCommandJSON *from_text(const char *text, bool ignore_extras = false)
      {
        GuessThatLyricHintCommandJSON *result;
          {
            ...
            parse_json_value(text, "Text for GuessThatLyricHintCommandJSON", &generator);
    ...
    static GuessThatLyricHintCommandJSON *from_file(FILE *fp, const char *file_name, bool ignore_extras = false)
      {
        GuessThatLyricHintCommandJSON *result;
          {
            JSONHoldingGenerator<Generator, RCHandle<GuessThatLyricHintCommandJSON>, GuessThatLyricHintCommandJSON *, bool> generator("Type GuessThatLyricHintCommand", ignore_extras);
    ...
    class Generator : public GuessThatLyricCommandJSON::Generator
      ...
      protected:
        ...
        void finish(void)
          {
            if (!(strcmp(getGuessThatLyricCommandJSONKey().c_str(), "GuessThatLyricHintCommand") == 0))
                throw("The key field has a value other than `GuessThatLyricHintCommand'.");
            GuessThatLyricHintCommandJSON *result = new GuessThatLyricHintCommandJSON();
            assert(result != NULL);
            RCHandle<GuessThatLyricHintCommandJSON> result_holder = result;
            finish(result);
            size_t extra_count = unknownFieldGenerator.field_names.size();
            assert(extra_count == unknownFieldGenerator.field_values.size());
            for (size_t extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result->extraGuessThatLyricHintCommandAppendPair(unknownFieldGenerator.field_names[extra_num].c_str(), unknownFieldGenerator.field_values[extra_num].referenced());
              }
        ...
        void finish(GuessThatLyricHintCommandJSON *result)
          {
        ...
        virtual void handle_result(GuessThatLyricHintCommandJSON *new_result) = 0;
      ...
      public:
        Generator(bool ignore_extras = false) : GuessThatLyricCommandJSON::Generator(ignore_extras), fieldGeneratorDecade("field \"Decade\" of the GuessThatLyricHintCommand class"), fieldGeneratorGuessedCorrectly("field \"GuessedCorrectly\" of the GuessThatLyricHintCommand class"), fieldGeneratorHintsRemaining("field \"HintsRemaining\" of the GuessThatLyricHintCommand class"), fieldGeneratorDifficulty("field \"Difficulty\" of the GuessThatLyricHintCommand class"), fieldGeneratorCorrectAnswer("field \"CorrectAnswer\" of the GuessThatLyricHintCommand class"), fieldGeneratorQuestion("field \"Question\" of the GuessThatLyricHintCommand class"), fieldGeneratorSoundhoundLyricID("field \"SoundhoundLyricID\" of the GuessThatLyricHintCommand class"), fieldGeneratorGTLSoundhoundTrackID("field \"GTLSoundhoundTrackID\" of the GuessThatLyricHintCommand class"), fieldGeneratorCorrectTitle("field \"CorrectTitle\" of the GuessThatLyricHintCommand class"), fieldGeneratorCorrectArtist("field \"CorrectArtist\" of the GuessThatLyricHintCommand class"), fieldGeneratorPlayerLost("field \"PlayerLost\" of the GuessThatLyricHintCommand class"), fieldGeneratorGuessedTracksList("field \"GuessedTracksList\" of the GuessThatLyricHintCommand class", ignore_extras), unknownFieldGenerator(ignore_extras)
          {
...
#endif /* GUESSTHATLYRICHINTCOMMANDJSON_H */
