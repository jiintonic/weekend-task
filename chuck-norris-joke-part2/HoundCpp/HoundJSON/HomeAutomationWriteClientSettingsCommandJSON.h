/* file "HomeAutomationWriteClientSettingsCommandJSON.h" */

/* Generated automatically by Classy JSON. */


#ifndef HOMEAUTOMATIONWRITECLIENTSETTINGSCOMMANDJSON_H
#define HOMEAUTOMATIONWRITECLIENTSETTINGSCOMMANDJSON_H
...
class HomeAutomationWriteClientSettingsCommandJSON : public HomeAutomationCommandJSON
  {
  private:
    ...
    HomeAutomationWriteClientSettingsCommandJSON(const HomeAutomationWriteClientSettingsCommandJSON &);
    HomeAutomationWriteClientSettingsCommandJSON & operator=(const HomeAutomationWriteClientSettingsCommandJSON &other);
  ...
  public:
    HomeAutomationWriteClientSettingsCommandJSON(void);
    virtual ~HomeAutomationWriteClientSettingsCommandJSON(void);
    ...
    virtual size_t extraHomeAutomationWriteClientSettingsCommandComponentCount(void) const
      {
        assert(extraKeys.size() == extraValues.size());
        return extraKeys.size();
      }
    virtual const char *extraHomeAutomationWriteClientSettingsCommandComponentKey(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraKeys[component_num].c_str();
      }
    virtual JSONValue *extraHomeAutomationWriteClientSettingsCommandComponentValue(size_t component_num)
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual const JSONValue *extraHomeAutomationWriteClientSettingsCommandComponentValue(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual JSONValue *extraHomeAutomationWriteClientSettingsCommandLookup(const char *field_name)
      {
    ...
    virtual const JSONValue *extraHomeAutomationWriteClientSettingsCommandLookup(const char *field_name) const
      {
        JSONValue *result = (JSONValue *)(lookup_in_string_index(extraIndex, field_name));
        if (result != NULL)
            result->add_reference();
    ...
    virtual void extraHomeAutomationWriteClientSettingsCommandAppendPair(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
    ...
    virtual void extraHomeAutomationWriteClientSettingsCommandSetField(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
        assert(new_component != NULL);
    ...
    static HomeAutomationWriteClientSettingsCommandJSON *from_json(JSONValue *json_value, bool ignore_extras = false);
    static HomeAutomationWriteClientSettingsCommandJSON *from_text(const char *text, bool ignore_extras = false)
      {
        HomeAutomationWriteClientSettingsCommandJSON *result;
          {
            ...
            parse_json_value(text, "Text for HomeAutomationWriteClientSettingsCommandJSON", &generator);
    ...
    static HomeAutomationWriteClientSettingsCommandJSON *from_file(FILE *fp, const char *file_name, bool ignore_extras = false)
      {
        HomeAutomationWriteClientSettingsCommandJSON *result;
          {
            JSONHoldingGenerator<Generator, RCHandle<HomeAutomationWriteClientSettingsCommandJSON>, HomeAutomationWriteClientSettingsCommandJSON *, bool> generator("Type HomeAutomationWriteClientSettingsCommand", ignore_extras);
    ...
    class Generator : public HomeAutomationCommandJSON::Generator
      ...
      protected:
        ...
        void finish(void)
          {
            if (!(strcmp(getHomeAutomationCommandJSONKey().c_str(), "HomeAutomationWriteClientSettingsCommand") == 0))
                throw("The key field has a value other than `HomeAutomationWriteClientSettingsCommand'.");
            HomeAutomationWriteClientSettingsCommandJSON *result = new HomeAutomationWriteClientSettingsCommandJSON();
            assert(result != NULL);
            RCHandle<HomeAutomationWriteClientSettingsCommandJSON> result_holder = result;
            finish(result);
            size_t extra_count = unknownFieldGenerator.field_names.size();
            assert(extra_count == unknownFieldGenerator.field_values.size());
            for (size_t extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result->extraHomeAutomationWriteClientSettingsCommandAppendPair(unknownFieldGenerator.field_names[extra_num].c_str(), unknownFieldGenerator.field_values[extra_num].referenced());
              }
        ...
        void finish(HomeAutomationWriteClientSettingsCommandJSON *result)
          {
        ...
        virtual void handle_result(HomeAutomationWriteClientSettingsCommandJSON *new_result) = 0;
      ...
      public:
        Generator(bool ignore_extras = false) : HomeAutomationCommandJSON::Generator(ignore_extras), fieldGeneratorHomeAutomationDomainSettings("field \"HomeAutomationDomainSettings\" of the HomeAutomationWriteClientSettingsCommand class", ignore_extras), unknownFieldGenerator(ignore_extras)
          {
...
#endif /* HOMEAUTOMATIONWRITECLIENTSETTINGSCOMMANDJSON_H */
