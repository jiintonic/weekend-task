/* file "SportsGameSchedulesScoresAPIGameJSON.h" */

/* Generated automatically by Classy JSON. */


#ifndef SPORTSGAMESCHEDULESSCORESAPIGAMEJSON_H
#define SPORTSGAMESCHEDULESSCORESAPIGAMEJSON_H
...
class SportsGameSchedulesScoresAPIGameJSON : public ReferenceCounted
  {
  public:
  ...
  private:
    ...
    SportsGameSchedulesScoresAPIGameJSON(const SportsGameSchedulesScoresAPIGameJSON &);
    SportsGameSchedulesScoresAPIGameJSON & operator=(const SportsGameSchedulesScoresAPIGameJSON &other);
  ...
  public:
    SportsGameSchedulesScoresAPIGameJSON(void);
    virtual ~SportsGameSchedulesScoresAPIGameJSON(void);
    ...
    virtual size_t extraSportsGameSchedulesScoresAPIGameComponentCount(void) const
      {
        assert(extraKeys.size() == extraValues.size());
        return extraKeys.size();
      }
    virtual const char *extraSportsGameSchedulesScoresAPIGameComponentKey(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraKeys[component_num].c_str();
      }
    virtual JSONValue *extraSportsGameSchedulesScoresAPIGameComponentValue(size_t component_num)
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual const JSONValue *extraSportsGameSchedulesScoresAPIGameComponentValue(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual JSONValue *extraSportsGameSchedulesScoresAPIGameLookup(const char *field_name)
      {
    ...
    virtual const JSONValue *extraSportsGameSchedulesScoresAPIGameLookup(const char *field_name) const
      {
        JSONValue *result = (JSONValue *)(lookup_in_string_index(extraIndex, field_name));
        if (result != NULL)
            result->add_reference();
    ...
    void setQuarterInningPeriod(OInteger new_value)
      {
        ...
        if (new_value < 0)
            throw("The value for field QuarterInningPeriod of SportsGameSchedulesScoresAPIGameJSON is less than the lower bound (0) for that field.");
    ...
    virtual void extraSportsGameSchedulesScoresAPIGameAppendPair(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
    ...
    virtual void extraSportsGameSchedulesScoresAPIGameSetField(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
        assert(new_component != NULL);

        JSONValue *old_field = extraSportsGameSchedulesScoresAPIGameLookup(key);
        if (old_field == NULL)
          {
            extraSportsGameSchedulesScoresAPIGameAppendPair(key, new_component);
          }
        else
          {
    ...
    static SportsGameSchedulesScoresAPIGameJSON *from_json(JSONValue *json_value, bool ignore_extras = false);
    static SportsGameSchedulesScoresAPIGameJSON *from_text(const char *text, bool ignore_extras = false)
      {
        SportsGameSchedulesScoresAPIGameJSON *result;
          {
            ...
            parse_json_value(text, "Text for SportsGameSchedulesScoresAPIGameJSON", &generator);
    ...
    static SportsGameSchedulesScoresAPIGameJSON *from_file(FILE *fp, const char *file_name, bool ignore_extras = false)
      {
        SportsGameSchedulesScoresAPIGameJSON *result;
          {
            JSONHoldingGenerator<Generator, RCHandle<SportsGameSchedulesScoresAPIGameJSON>, SportsGameSchedulesScoresAPIGameJSON *, bool> generator("Type SportsGameSchedulesScoresAPIGame", ignore_extras);
    ...
    class FieldGeneratorSportsResultType : public JSONStringGenerator
      ...
      protected:
        ...
        void finish(void)
          {
            SportsGameSchedulesScoresAPIGameJSON *result = new SportsGameSchedulesScoresAPIGameJSON();
            assert(result != NULL);
            RCHandle<SportsGameSchedulesScoresAPIGameJSON> result_holder = result;
            finish(result);
            size_t extra_count = unknownFieldGenerator.field_names.size();
            assert(extra_count == unknownFieldGenerator.field_values.size());
            for (size_t extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result->extraSportsGameSchedulesScoresAPIGameAppendPair(unknownFieldGenerator.field_names[extra_num].c_str(), unknownFieldGenerator.field_values[extra_num].referenced());
              }
        ...
        void finish(SportsGameSchedulesScoresAPIGameJSON *result)
          {
        ...
        virtual void handle_result(SportsGameSchedulesScoresAPIGameJSON *new_result) = 0;
                        ...
                        switch ((unsigned char)(field_name[5]))
                          {
                            case 'I':
                                ...
                                break;
                            case 's':
                                if (strcmp(&(field_name[6]), "ResultType") == 0)
      ...
      public:
        Generator(bool ignore_extras = false) : fieldGeneratorTeams("field \"Teams\" of the SportsGameSchedulesScoresAPIGame class", ignore_extras), fieldGeneratorGameStartTime("field \"GameStartTime\" of the SportsGameSchedulesScoresAPIGame class", ignore_extras), fieldGeneratorGameStatus("field \"GameStatus\" of the SportsGameSchedulesScoresAPIGame class"), fieldGeneratorQuarterInningPeriod("field \"QuarterInningPeriod\" of the SportsGameSchedulesScoresAPIGame class"), fieldGeneratorQuarterInningPeriodClock("field \"QuarterInningPeriodClock\" of the SportsGameSchedulesScoresAPIGame class"), fieldGeneratorVenue("field \"Venue\" of the SportsGameSchedulesScoresAPIGame class", ignore_extras), fieldGeneratorBroadcastNetwork("field \"BroadcastNetwork\" of the SportsGameSchedulesScoresAPIGame class"), fieldGeneratorSportsResultType("field \"SportsResultType\" of the SportsGameSchedulesScoresAPIGame class"), fieldGeneratorPlayoffs("field \"Playoffs\" of the SportsGameSchedulesScoresAPIGame class"), fieldGeneratorPlayoffGame("field \"PlayoffGame\" of the SportsGameSchedulesScoresAPIGame class"), fieldGeneratorPlayoffType("field \"PlayoffType\" of the SportsGameSchedulesScoresAPIGame class", ignore_extras), fieldGeneratorTournament("field \"Tournament\" of the SportsGameSchedulesScoresAPIGame class", ignore_extras), fieldGeneratorPreSeason("field \"PreSeason\" of the SportsGameSchedulesScoresAPIGame class"), fieldGeneratorGameID("field \"GameID\" of the SportsGameSchedulesScoresAPIGame class"), fieldGeneratorSportImage("field \"SportImage\" of the SportsGameSchedulesScoresAPIGame class", ignore_extras), unknownFieldGenerator(ignore_extras)
          {
            set_what("the SportsGameSchedulesScoresAPIGame class");
          }
        ~Generator(void)
          {
          }
...
#endif /* SPORTSGAMESCHEDULESSCORESAPIGAMEJSON_H */
