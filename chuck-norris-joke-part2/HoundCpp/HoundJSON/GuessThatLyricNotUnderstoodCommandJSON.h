/* file "GuessThatLyricNotUnderstoodCommandJSON.h" */

/* Generated automatically by Classy JSON. */


#ifndef GUESSTHATLYRICNOTUNDERSTOODCOMMANDJSON_H
#define GUESSTHATLYRICNOTUNDERSTOODCOMMANDJSON_H
...
class GuessThatLyricNotUnderstoodCommandJSON : public GuessThatLyricCommandJSON
  {
  private:
    bool flagHasDecade;
    ...
    GuessThatLyricNotUnderstoodCommandJSON(const GuessThatLyricNotUnderstoodCommandJSON &);
    GuessThatLyricNotUnderstoodCommandJSON & operator=(const GuessThatLyricNotUnderstoodCommandJSON &other);
  ...
  public:
    GuessThatLyricNotUnderstoodCommandJSON(void);
    virtual ~GuessThatLyricNotUnderstoodCommandJSON(void);
    const char * getGuessThatLyricCommandKind(void) const;
    ...
    virtual size_t extraGuessThatLyricNotUnderstoodCommandComponentCount(void) const
      {
        assert(extraKeys.size() == extraValues.size());
        return extraKeys.size();
      }
    virtual const char *extraGuessThatLyricNotUnderstoodCommandComponentKey(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraKeys[component_num].c_str();
      }
    virtual JSONValue *extraGuessThatLyricNotUnderstoodCommandComponentValue(size_t component_num)
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual const JSONValue *extraGuessThatLyricNotUnderstoodCommandComponentValue(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual JSONValue *extraGuessThatLyricNotUnderstoodCommandLookup(const char *field_name)
      {
    ...
    virtual const JSONValue *extraGuessThatLyricNotUnderstoodCommandLookup(const char *field_name) const
      {
        JSONValue *result = (JSONValue *)(lookup_in_string_index(extraIndex, field_name));
        if (result != NULL)
            result->add_reference();
    ...
    void setDecade(OInteger new_value)
      {
        flagHasDecade = true;
        if (new_value < 0)
            throw("The value for field Decade of GuessThatLyricNotUnderstoodCommandJSON is less than the lower bound (0) for that field.");
        storeDecade = new_value;
        GuessThatLyricCommandJSON::setDecade(new_value);
      }
    void unsetDecade(void)
      {
        flagHasDecade = false;
        GuessThatLyricCommandJSON::unsetDecade();
      }
    void setGuessedCorrectly(OInteger new_value)
      {
        flagHasGuessedCorrectly = true;
        if (new_value < 0)
            throw("The value for field GuessedCorrectly of GuessThatLyricNotUnderstoodCommandJSON is less than the lower bound (0) for that field.");
        storeGuessedCorrectly = new_value;
        GuessThatLyricCommandJSON::setGuessedCorrectly(new_value);
      }
    void unsetGuessedCorrectly(void)
      {
        flagHasGuessedCorrectly = false;
        GuessThatLyricCommandJSON::unsetGuessedCorrectly();
      }
    void setHintsRemaining(uint8_t new_value)
      {
        flagHasHintsRemaining = true;
        if (new_value < 0)
            throw("The value for field HintsRemaining of GuessThatLyricNotUnderstoodCommandJSON is less than the lower bound (0) for that field.");
        if (new_value > 4)
            throw("The value for field HintsRemaining of GuessThatLyricNotUnderstoodCommandJSON is greater than the upper bound (4) for that field.");
        storeHintsRemaining = new_value;
        GuessThatLyricCommandJSON::setHintsRemaining(new_value);
      }
    void unsetHintsRemaining(void)
      {
        flagHasHintsRemaining = false;
        GuessThatLyricCommandJSON::unsetHintsRemaining();
      }
    void setDifficulty(std::string new_value)
      {
        flagHasDifficulty = true;
        storeDifficulty = new_value;
        GuessThatLyricCommandJSON::setDifficulty(new_value);
      }
    void unsetDifficulty(void)
      {
        flagHasDifficulty = false;
        GuessThatLyricCommandJSON::unsetDifficulty();
      }
    void setCorrectAnswer(std::string new_value)
      {
        flagHasCorrectAnswer = true;
        storeCorrectAnswer = new_value;
        GuessThatLyricCommandJSON::setCorrectAnswer(new_value);
      }
    void unsetCorrectAnswer(void)
      {
        flagHasCorrectAnswer = false;
        GuessThatLyricCommandJSON::unsetCorrectAnswer();
      }
    void setQuestion(std::string new_value)
      {
        flagHasQuestion = true;
        storeQuestion = new_value;
        GuessThatLyricCommandJSON::setQuestion(new_value);
      }
    void unsetQuestion(void)
      {
        flagHasQuestion = false;
        GuessThatLyricCommandJSON::unsetQuestion();
      }
    void setSoundhoundLyricID(std::string new_value)
      {
        flagHasSoundhoundLyricID = true;
        storeSoundhoundLyricID = new_value;
        GuessThatLyricCommandJSON::setSoundhoundLyricID(new_value);
      }
    void unsetSoundhoundLyricID(void)
      {
        flagHasSoundhoundLyricID = false;
        GuessThatLyricCommandJSON::unsetSoundhoundLyricID();
      }
    void setGTLSoundhoundTrackID(std::string new_value)
      {
        flagHasGTLSoundhoundTrackID = true;
        storeGTLSoundhoundTrackID = new_value;
        GuessThatLyricCommandJSON::setGTLSoundhoundTrackID(new_value);
      }
    void unsetGTLSoundhoundTrackID(void)
      {
        flagHasGTLSoundhoundTrackID = false;
        GuessThatLyricCommandJSON::unsetGTLSoundhoundTrackID();
      }
    void setCorrectTitle(std::string new_value)
      {
        flagHasCorrectTitle = true;
        storeCorrectTitle = new_value;
        GuessThatLyricCommandJSON::setCorrectTitle(new_value);
      }
    void unsetCorrectTitle(void)
      {
        flagHasCorrectTitle = false;
        GuessThatLyricCommandJSON::unsetCorrectTitle();
      }
    void setCorrectArtist(std::string new_value)
      {
        flagHasCorrectArtist = true;
        storeCorrectArtist = new_value;
        GuessThatLyricCommandJSON::setCorrectArtist(new_value);
      }
    void unsetCorrectArtist(void)
      {
        flagHasCorrectArtist = false;
        GuessThatLyricCommandJSON::unsetCorrectArtist();
      }
    void setPlayerLost(bool new_value)
      {
        flagHasPlayerLost = true;
        storePlayerLost = new_value;
        GuessThatLyricCommandJSON::setPlayerLost(new_value);
      }
    void unsetPlayerLost(void)
      {
        flagHasPlayerLost = false;
        GuessThatLyricCommandJSON::unsetPlayerLost();
      }
    ...
    virtual void extraGuessThatLyricNotUnderstoodCommandAppendPair(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
    ...
    virtual void extraGuessThatLyricNotUnderstoodCommandSetField(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
        assert(new_component != NULL);
    ...
    virtual void write_fields_as_json(JSONHandler *handler) const
      {
        GuessThatLyricCommandJSON::write_fields_as_json(handler);
      }
    virtual void writeFieldDecade(JSONHandler *handler) const
      {
        assert(flagHasDecade);
        handler->start_pair("Decade");
        handler->number_value(storeDecade.get_o_integer());
      }
    virtual void writeFieldGuessedCorrectly(JSONHandler *handler) const
      {
    ...
    virtual void writeFieldGuessedTracksList(JSONHandler *handler) const
      {
        if (flagHasGuessedTracksList)
          {
    ...
    static GuessThatLyricNotUnderstoodCommandJSON *from_json(JSONValue *json_value, bool ignore_extras = false);
    static GuessThatLyricNotUnderstoodCommandJSON *from_text(const char *text, bool ignore_extras = false)
      {
        GuessThatLyricNotUnderstoodCommandJSON *result;
          {
            ...
            parse_json_value(text, "Text for GuessThatLyricNotUnderstoodCommandJSON", &generator);
    ...
    static GuessThatLyricNotUnderstoodCommandJSON *from_file(FILE *fp, const char *file_name, bool ignore_extras = false)
      {
        GuessThatLyricNotUnderstoodCommandJSON *result;
          {
            JSONHoldingGenerator<Generator, RCHandle<GuessThatLyricNotUnderstoodCommandJSON>, GuessThatLyricNotUnderstoodCommandJSON *, bool> generator("Type GuessThatLyricNotUnderstoodCommand", ignore_extras);
    ...
    class Generator : public GuessThatLyricCommandJSON::Generator
      {
      private:
      ...
      protected:
        ...
        void finish(void)
          {
            if (!(strcmp(getGuessThatLyricCommandJSONKey().c_str(), "GuessThatLyricNotUnderstoodCommand") == 0))
                throw("The key field has a value other than `GuessThatLyricNotUnderstoodCommand'.");
            GuessThatLyricNotUnderstoodCommandJSON *result = new GuessThatLyricNotUnderstoodCommandJSON();
            assert(result != NULL);
            RCHandle<GuessThatLyricNotUnderstoodCommandJSON> result_holder = result;
            finish(result);
            size_t extra_count = unknownFieldGenerator.field_names.size();
            assert(extra_count == unknownFieldGenerator.field_values.size());
            for (size_t extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result->extraGuessThatLyricNotUnderstoodCommandAppendPair(unknownFieldGenerator.field_names[extra_num].c_str(), unknownFieldGenerator.field_values[extra_num].referenced());
              }
        ...
        void handle_result(GuessThatLyricCommandJSON *new_result)
          {
            handle_result((GuessThatLyricNotUnderstoodCommandJSON *)new_result);
          }
        void finish(GuessThatLyricNotUnderstoodCommandJSON *result)
          {
            ...
            GuessThatLyricCommandJSON::Generator::finish(result);
          }
        virtual void handle_result(GuessThatLyricNotUnderstoodCommandJSON *new_result) = 0;
        virtual JSONHandler *start_known_field(const char *field_name)
          {
            ...
            return GuessThatLyricCommandJSON::Generator::start_known_field(field_name);
          }

      public:
        Generator(bool ignore_extras = false) : GuessThatLyricCommandJSON::Generator(ignore_extras), fieldGeneratorDecade("field \"Decade\" of the GuessThatLyricNotUnderstoodCommand class"), fieldGeneratorGuessedCorrectly("field \"GuessedCorrectly\" of the GuessThatLyricNotUnderstoodCommand class"), fieldGeneratorHintsRemaining("field \"HintsRemaining\" of the GuessThatLyricNotUnderstoodCommand class"), fieldGeneratorDifficulty("field \"Difficulty\" of the GuessThatLyricNotUnderstoodCommand class"), fieldGeneratorCorrectAnswer("field \"CorrectAnswer\" of the GuessThatLyricNotUnderstoodCommand class"), fieldGeneratorQuestion("field \"Question\" of the GuessThatLyricNotUnderstoodCommand class"), fieldGeneratorSoundhoundLyricID("field \"SoundhoundLyricID\" of the GuessThatLyricNotUnderstoodCommand class"), fieldGeneratorGTLSoundhoundTrackID("field \"GTLSoundhoundTrackID\" of the GuessThatLyricNotUnderstoodCommand class"), fieldGeneratorCorrectTitle("field \"CorrectTitle\" of the GuessThatLyricNotUnderstoodCommand class"), fieldGeneratorCorrectArtist("field \"CorrectArtist\" of the GuessThatLyricNotUnderstoodCommand class"), fieldGeneratorPlayerLost("field \"PlayerLost\" of the GuessThatLyricNotUnderstoodCommand class"), fieldGeneratorGuessedTracksList("field \"GuessedTracksList\" of the GuessThatLyricNotUnderstoodCommand class", ignore_extras), unknownFieldGenerator(ignore_extras)
          {
        ...
        void reset(void)
          {
            ...
            GuessThatLyricCommandJSON::Generator::reset();
            unknownFieldGenerator.reset();
          }
      };
  };

#endif /* GUESSTHATLYRICNOTUNDERSTOODCOMMANDJSON_H */
