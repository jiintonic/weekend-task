/* file "CabinClassJSON.h" */

/* Generated automatically by Classy JSON. */


#ifndef CABINCLASSJSON_H
#define CABINCLASSJSON_H
...
class CabinClassJSON : public ReferenceCounted
  {
  public:
  ...
  private:
    ...
    CabinClassJSON(const CabinClassJSON &);
    CabinClassJSON & operator=(const CabinClassJSON &other);
  ...
  public:
    CabinClassJSON(void);
    CabinClassJSON(TypeValue init_value);
    CabinClassJSON(const char *init_value);
    CabinClassJSON(std::string init_value);
    CabinClassJSON(TypeValueKnownValues init_value);
    virtual ~CabinClassJSON(void);
    ...
    static CabinClassJSON *from_json(JSONValue *json_value, bool ignore_extras = false);
    static CabinClassJSON *from_text(const char *text, bool ignore_extras = false)
      {
        CabinClassJSON *result;
          {
            ...
            parse_json_value(text, "Text for CabinClassJSON", &generator);
    ...
    static CabinClassJSON *from_file(FILE *fp, const char *file_name, bool ignore_extras = false)
      {
        CabinClassJSON *result;
          {
            JSONHoldingGenerator<Generator, RCHandle<CabinClassJSON>, CabinClassJSON *, bool> generator("Type CabinClass", ignore_extras);
    ...
    class Generator : public FieldGeneratorValue
      ...
      protected:
        ...
        virtual void handle_result(CabinClassJSON *new_result) = 0;
