/* file "GuessThatLyricCommandJSON.h" */

/* Generated automatically by Classy JSON. */


#ifndef GUESSTHATLYRICCOMMANDJSON_H
#define GUESSTHATLYRICCOMMANDJSON_H
...
class GuessThatLyricCommandJSON : public MusicCommandJSON
  {
  private:
    bool flagHasDecade;
    ...
    GuessThatLyricCommandJSON(const GuessThatLyricCommandJSON &);
    GuessThatLyricCommandJSON & operator=(const GuessThatLyricCommandJSON &other);
  ...
  public:
    GuessThatLyricCommandJSON(void);
    virtual ~GuessThatLyricCommandJSON(void);
    const char * getMusicCommandKind(void) const;
    virtual const char *getGuessThatLyricCommandKind(void) const = 0;
    ...
    virtual size_t extraGuessThatLyricCommandComponentCount(void) const = 0;
    virtual const char *extraGuessThatLyricCommandComponentKey(size_t component_num) const = 0;
    virtual JSONValue *extraGuessThatLyricCommandComponentValue(size_t component_num) = 0;
    virtual const JSONValue *extraGuessThatLyricCommandComponentValue(size_t component_num) const = 0;
    virtual JSONValue *extraGuessThatLyricCommandLookup(const char *field_name) = 0;
    virtual const JSONValue *extraGuessThatLyricCommandLookup(const char *field_name) const = 0;
                        ...
                        if (strncmp(&(field_name[2]), "ess", 3) == 0)
                          {
                            switch ((unsigned char)(field_name[5]))
                              {
                                case 'T':
                                    if (strcmp(&(field_name[6]), "hatLyricCommandKind") == 0)
                                        return new JSONStringValue(getGuessThatLyricCommandKind());
                                    break;
                                case 'e':
                                    if (strncmp(&(field_name[6]), "d", 1) == 0)
                                      {
                                        switch ((unsigned char)(field_name[7]))
                                          {
                                            case 'C':
    ...
    virtual void setDecade(OInteger new_value)
      {
        flagHasDecade = true;
        if (new_value < 0)
            throw("The value for field Decade of GuessThatLyricCommandJSON is less than the lower bound (0) for that field.");
        storeDecade = new_value;
      }
    virtual void unsetDecade(void)
      {
        flagHasDecade = false;
      }
    virtual void setGuessedCorrectly(OInteger new_value)
      {
        flagHasGuessedCorrectly = true;
        if (new_value < 0)
            throw("The value for field GuessedCorrectly of GuessThatLyricCommandJSON is less than the lower bound (0) for that field.");
        storeGuessedCorrectly = new_value;
      }
    virtual void unsetGuessedCorrectly(void)
      {
        flagHasGuessedCorrectly = false;
      }
    virtual void setHintsRemaining(uint8_t new_value)
      {
        flagHasHintsRemaining = true;
        if (new_value < 0)
            throw("The value for field HintsRemaining of GuessThatLyricCommandJSON is less than the lower bound (0) for that field.");
        if (new_value > 4)
            throw("The value for field HintsRemaining of GuessThatLyricCommandJSON is greater than the upper bound (4) for that field.");
        storeHintsRemaining = new_value;
      }
    virtual void unsetHintsRemaining(void)
      {
        flagHasHintsRemaining = false;
      }
    virtual void setDifficulty(std::string new_value)
      {
        flagHasDifficulty = true;
        storeDifficulty = new_value;
      }
    virtual void unsetDifficulty(void)
      {
        flagHasDifficulty = false;
      }
    virtual void setCorrectAnswer(std::string new_value)
      {
        flagHasCorrectAnswer = true;
        storeCorrectAnswer = new_value;
      }
    virtual void unsetCorrectAnswer(void)
      {
        flagHasCorrectAnswer = false;
      }
    virtual void setQuestion(std::string new_value)
      {
        flagHasQuestion = true;
        storeQuestion = new_value;
      }
    virtual void unsetQuestion(void)
      {
        flagHasQuestion = false;
      }
    virtual void setSoundhoundLyricID(std::string new_value)
      {
        flagHasSoundhoundLyricID = true;
        storeSoundhoundLyricID = new_value;
      }
    virtual void unsetSoundhoundLyricID(void)
      {
        flagHasSoundhoundLyricID = false;
      }
    virtual void setGTLSoundhoundTrackID(std::string new_value)
      {
        flagHasGTLSoundhoundTrackID = true;
        storeGTLSoundhoundTrackID = new_value;
      }
    virtual void unsetGTLSoundhoundTrackID(void)
      {
        flagHasGTLSoundhoundTrackID = false;
      }
    virtual void setCorrectTitle(std::string new_value)
      {
        flagHasCorrectTitle = true;
        storeCorrectTitle = new_value;
      }
    virtual void unsetCorrectTitle(void)
      {
        flagHasCorrectTitle = false;
      }
    virtual void setCorrectArtist(std::string new_value)
      {
        flagHasCorrectArtist = true;
        storeCorrectArtist = new_value;
      }
    virtual void unsetCorrectArtist(void)
      {
        flagHasCorrectArtist = false;
      }
    virtual void setPlayerLost(bool new_value)
      {
        flagHasPlayerLost = true;
        storePlayerLost = new_value;
      }
    virtual void unsetPlayerLost(void)
      {
    ...
    virtual void extraGuessThatLyricCommandAppendPair(const char *key, JSONValue *new_component) = 0;
    virtual void extraGuessThatLyricCommandSetField(const char *key, JSONValue *new_component) = 0;
                ...
                switch ((unsigned char)(key[1]))
                  {
                    case 'T':
                        ...
                        break;
                    case 'u':
                        if (strncmp(&(key[2]), "ess", 3) == 0)
                          {
                            switch ((unsigned char)(key[5]))
                              {
                                case 'T':
                                    if (strcmp(&(key[6]), "hatLyricCommandKind") == 0)
                                        return;
                                    break;
                                case 'e':
                                    if (strncmp(&(key[6]), "d", 1) == 0)
                                      {
                                        switch ((unsigned char)(key[7]))
                                          {
                                            case 'C':
    ...
    static GuessThatLyricCommandJSON *from_json(JSONValue *json_value, bool ignore_extras = false);
    static GuessThatLyricCommandJSON *from_text(const char *text, bool ignore_extras = false)
      {
        GuessThatLyricCommandJSON *result;
          {
            ...
            parse_json_value(text, "Text for GuessThatLyricCommandJSON", &generator);
    ...
    static GuessThatLyricCommandJSON *from_file(FILE *fp, const char *file_name, bool ignore_extras = false)
      {
        GuessThatLyricCommandJSON *result;
          {
            JSONHoldingGenerator<Generator, RCHandle<GuessThatLyricCommandJSON>, GuessThatLyricCommandJSON *, bool> generator("Type GuessThatLyricCommand", ignore_extras);
    ...
    class Generator : public MusicCommandJSON::Generator
      ...
      protected:
        ...
        void finish(void)
          {
            ...
            if (!(strcmp(getMusicCommandJSONKey().c_str(), "GuessThatLyricCommand") == 0))
                throw("The key field has a value other than `GuessThatLyricCommand'.");
            GuessThatLyricCommandJSON *result = createForKey(keyGenerator.value.c_str(), unknownFieldGenerator.index);
            assert(result != NULL);
            RCHandle<GuessThatLyricCommandJSON> result_holder = result;
            finish(result);
            size_t extra_count = unknownFieldGenerator.field_names.size();
            assert(extra_count == unknownFieldGenerator.field_values.size());
            for (size_t extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result->extraGuessThatLyricCommandAppendPair(unknownFieldGenerator.field_names[extra_num].c_str(), unknownFieldGenerator.field_values[extra_num].referenced());
              }
        ...
        std::string getGuessThatLyricCommandJSONKey(void)
          {
            if (!(keyGenerator.have_value))
                throw("The `GuessThatLyricCommandKind' field is missing.");
        ...
        void finish(GuessThatLyricCommandJSON *result)
          {
        ...
        virtual void handle_result(GuessThatLyricCommandJSON *new_result) = 0;
      ...
      public:
        Generator(bool ignore_extras = false) : MusicCommandJSON::Generator(ignore_extras), fieldGeneratorDecade("field \"Decade\" of the GuessThatLyricCommand class"), fieldGeneratorGuessedCorrectly("field \"GuessedCorrectly\" of the GuessThatLyricCommand class"), fieldGeneratorHintsRemaining("field \"HintsRemaining\" of the GuessThatLyricCommand class"), fieldGeneratorDifficulty("field \"Difficulty\" of the GuessThatLyricCommand class"), fieldGeneratorCorrectAnswer("field \"CorrectAnswer\" of the GuessThatLyricCommand class"), fieldGeneratorQuestion("field \"Question\" of the GuessThatLyricCommand class"), fieldGeneratorSoundhoundLyricID("field \"SoundhoundLyricID\" of the GuessThatLyricCommand class"), fieldGeneratorGTLSoundhoundTrackID("field \"GTLSoundhoundTrackID\" of the GuessThatLyricCommand class"), fieldGeneratorCorrectTitle("field \"CorrectTitle\" of the GuessThatLyricCommand class"), fieldGeneratorCorrectArtist("field \"CorrectArtist\" of the GuessThatLyricCommand class"), fieldGeneratorPlayerLost("field \"PlayerLost\" of the GuessThatLyricCommand class"), fieldGeneratorGuessedTracksList("field \"GuessedTracksList\" of the GuessThatLyricCommand class", ignore_extras), unknownFieldGenerator(ignore_extras), keyGenerator("key field \"GuessThatLyricCommandKind\" of the GuessThatLyricCommand class")
          {
    ...
    static GuessThatLyricCommandJSON *createForKey(const char *key, string_index *other_field_index);
  };

#endif /* GUESSTHATLYRICCOMMANDJSON_H */
