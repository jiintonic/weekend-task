/* file "NavigationNotUnderstoodCommandJSON.h" */

/* Generated automatically by Classy JSON. */


#ifndef NAVIGATIONNOTUNDERSTOODCOMMANDJSON_H
#define NAVIGATIONNOTUNDERSTOODCOMMANDJSON_H
...
class NavigationNotUnderstoodCommandJSON : public NavigationCommandJSON
  {
  private:

    NavigationNotUnderstoodCommandJSON(const NavigationNotUnderstoodCommandJSON &);
    NavigationNotUnderstoodCommandJSON & operator=(const NavigationNotUnderstoodCommandJSON &other);

  public:
    NavigationNotUnderstoodCommandJSON(void);
    virtual ~NavigationNotUnderstoodCommandJSON(void);
    ...
    static NavigationNotUnderstoodCommandJSON *from_json(JSONValue *json_value, bool ignore_extras = false);
    static NavigationNotUnderstoodCommandJSON *from_text(const char *text, bool ignore_extras = false)
      {
        NavigationNotUnderstoodCommandJSON *result;
          {
            ...
            parse_json_value(text, "Text for NavigationNotUnderstoodCommandJSON", &generator);
    ...
    static NavigationNotUnderstoodCommandJSON *from_file(FILE *fp, const char *file_name, bool ignore_extras = false)
      {
        NavigationNotUnderstoodCommandJSON *result;
          {
            JSONHoldingGenerator<Generator, RCHandle<NavigationNotUnderstoodCommandJSON>, NavigationNotUnderstoodCommandJSON *, bool> generator("Type NavigationNotUnderstoodCommand", ignore_extras);
    ...
    class Generator : public NavigationCommandJSON::Generator
      ...
      protected:
        ...
        void finish(void)
          {
            if (!(strcmp(getNavigationCommandJSONKey().c_str(), "NavigationNotUnderstoodCommand") == 0))
                throw("The key field has a value other than `NavigationNotUnderstoodCommand'.");
            NavigationNotUnderstoodCommandJSON *result = new NavigationNotUnderstoodCommandJSON();
            assert(result != NULL);
            RCHandle<NavigationNotUnderstoodCommandJSON> result_holder = result;
            finish(result);
        ...
        void finish(NavigationNotUnderstoodCommandJSON *result)
          {
            NavigationCommandJSON::Generator::finish(result);
          }
        virtual void handle_result(NavigationNotUnderstoodCommandJSON *new_result) = 0;
...
#endif /* NAVIGATIONNOTUNDERSTOODCOMMANDJSON_H */
