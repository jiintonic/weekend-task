/* file "RockPaperScissorsNotUnderstoodCommandJSON.h" */

/* Generated automatically by Classy JSON. */


#ifndef ROCKPAPERSCISSORSNOTUNDERSTOODCOMMANDJSON_H
#define ROCKPAPERSCISSORSNOTUNDERSTOODCOMMANDJSON_H
...
class RockPaperScissorsNotUnderstoodCommandJSON : public RockPaperScissorsCommandJSON
  {
  public:
  ...
  private:
    ...
    RockPaperScissorsNotUnderstoodCommandJSON(const RockPaperScissorsNotUnderstoodCommandJSON &);
    RockPaperScissorsNotUnderstoodCommandJSON & operator=(const RockPaperScissorsNotUnderstoodCommandJSON &other);
  ...
  public:
    RockPaperScissorsNotUnderstoodCommandJSON(void);
    virtual ~RockPaperScissorsNotUnderstoodCommandJSON(void);
    ...
    virtual size_t extraRockPaperScissorsNotUnderstoodCommandComponentCount(void) const
      {
        assert(extraKeys.size() == extraValues.size());
        return extraKeys.size();
      }
    virtual const char *extraRockPaperScissorsNotUnderstoodCommandComponentKey(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraKeys[component_num].c_str();
      }
    virtual JSONValue *extraRockPaperScissorsNotUnderstoodCommandComponentValue(size_t component_num)
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual const JSONValue *extraRockPaperScissorsNotUnderstoodCommandComponentValue(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual JSONValue *extraRockPaperScissorsNotUnderstoodCommandLookup(const char *field_name)
      {
        JSONValue *result = (JSONValue *)(lookup_in_string_index(extraIndex, field_name));
        if (result != NULL)
            result->add_reference();
    ...
    virtual const JSONValue *extraRockPaperScissorsNotUnderstoodCommandLookup(const char *field_name) const
      {
        JSONValue *result = (JSONValue *)(lookup_in_string_index(extraIndex, field_name));
        if (result != NULL)
            result->add_reference();
    ...
    virtual void extraRockPaperScissorsNotUnderstoodCommandAppendPair(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
        assert(new_component != NULL);
    ...
    virtual void extraRockPaperScissorsNotUnderstoodCommandSetField(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
        assert(new_component != NULL);
    ...
    static RockPaperScissorsNotUnderstoodCommandJSON *from_json(JSONValue *json_value, bool ignore_extras = false);
    static RockPaperScissorsNotUnderstoodCommandJSON *from_text(const char *text, bool ignore_extras = false)
      {
        RockPaperScissorsNotUnderstoodCommandJSON *result;
          {
            ...
            parse_json_value(text, "Text for RockPaperScissorsNotUnderstoodCommandJSON", &generator);
            assert(generator.have_value);
            result = generator.value.referenced();
            result->add_reference();
          };
    ...
    static RockPaperScissorsNotUnderstoodCommandJSON *from_file(FILE *fp, const char *file_name, bool ignore_extras = false)
      {
        RockPaperScissorsNotUnderstoodCommandJSON *result;
          {
            JSONHoldingGenerator<Generator, RCHandle<RockPaperScissorsNotUnderstoodCommandJSON>, RockPaperScissorsNotUnderstoodCommandJSON *, bool> generator("Type RockPaperScissorsNotUnderstoodCommand", ignore_extras);
    ...
    class Generator : public RockPaperScissorsCommandJSON::Generator
      ...
      protected:
        ...
        void finish(void)
          {
            if (!(strcmp(getRockPaperScissorsCommandJSONKey().c_str(), "RockPaperScissorsNotUnderstoodCommand") == 0))
                throw("The key field has a value other than `RockPaperScissorsNotUnderstoodCommand'.");
            RockPaperScissorsNotUnderstoodCommandJSON *result = new RockPaperScissorsNotUnderstoodCommandJSON();
            assert(result != NULL);
            RCHandle<RockPaperScissorsNotUnderstoodCommandJSON> result_holder = result;
            finish(result);
            size_t extra_count = unknownFieldGenerator.field_names.size();
            assert(extra_count == unknownFieldGenerator.field_values.size());
            for (size_t extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result->extraRockPaperScissorsNotUnderstoodCommandAppendPair(unknownFieldGenerator.field_names[extra_num].c_str(), unknownFieldGenerator.field_values[extra_num].referenced());
              }
            unknownFieldGenerator.field_names.clear();
            unknownFieldGenerator.field_values.clear();
            destroy_string_index(unknownFieldGenerator.index);
        ...
        void finish(RockPaperScissorsNotUnderstoodCommandJSON *result)
          {
        ...
        virtual void handle_result(RockPaperScissorsNotUnderstoodCommandJSON *new_result) = 0;
        virtual JSONHandler *start_known_field(const char *field_name)
          {
            if (strcmp(field_name, "NativeData") == 0)
      ...
      public:
        Generator(bool ignore_extras = false) : RockPaperScissorsCommandJSON::Generator(ignore_extras), fieldGeneratorNativeData("field \"NativeData\" of the RockPaperScissorsNotUnderstoodCommand class", ignore_extras), unknownFieldGenerator(ignore_extras)
          {
...
#endif /* ROCKPAPERSCISSORSNOTUNDERSTOODCOMMANDJSON_H */
