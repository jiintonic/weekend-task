/* file "SortOrderJSON.h" */

/* Generated automatically by Classy JSON. */


#ifndef SORTORDERJSON_H
#define SORTORDERJSON_H
...
class SortOrderJSON : public ReferenceCounted
  {
  public:
  ...
  private:
    ...
    SortOrderJSON(const SortOrderJSON &);
    SortOrderJSON & operator=(const SortOrderJSON &other);
  ...
  public:
    SortOrderJSON(void);
    SortOrderJSON(TypeValue init_value);
    SortOrderJSON(const char *init_value);
    SortOrderJSON(std::string init_value);
    SortOrderJSON(TypeValueKnownValues init_value);
    virtual ~SortOrderJSON(void);
    ...
    static SortOrderJSON *from_json(JSONValue *json_value, bool ignore_extras = false);
    static SortOrderJSON *from_text(const char *text, bool ignore_extras = false)
      {
        SortOrderJSON *result;
          {
            ...
            parse_json_value(text, "Text for SortOrderJSON", &generator);
    ...
    static SortOrderJSON *from_file(FILE *fp, const char *file_name, bool ignore_extras = false)
      {
        SortOrderJSON *result;
          {
            JSONHoldingGenerator<Generator, RCHandle<SortOrderJSON>, SortOrderJSON *, bool> generator("Type SortOrder", ignore_extras);
    ...
    class Generator : public FieldGeneratorValue
      ...
      protected:
        ...
        virtual void handle_result(SortOrderJSON *new_result) = 0;
