/* file "FlightSeatPreferencesJSON.h" */

/* Generated automatically by Classy JSON. */


#ifndef FLIGHTSEATPREFERENCESJSON_H
#define FLIGHTSEATPREFERENCESJSON_H
...
class FlightSeatPreferencesJSON : public ReferenceCounted
  {
  private:
    bool flagHasIncludes;
    std::vector< FlightSeatTypeJSON * > storeIncludes;
    bool flagHasExcludes;
    std::vector< FlightSeatTypeJSON * > storeExcludes;
    ...
    FlightSeatPreferencesJSON(const FlightSeatPreferencesJSON &);
    FlightSeatPreferencesJSON & operator=(const FlightSeatPreferencesJSON &other);
  ...
  public:
    FlightSeatPreferencesJSON(void);
    virtual ~FlightSeatPreferencesJSON(void);
    bool  hasIncludes(void) const;
    size_t  countOfIncludes(void) const;
    FlightSeatTypeJSON *  elementOfIncludes(size_t element_num);
    const FlightSeatTypeJSON *  elementOfIncludes(size_t element_num) const;
    std::vector< FlightSeatTypeJSON * >  getIncludes(void);
    const std::vector< FlightSeatTypeJSON * >  getIncludes(void) const;
    bool  hasExcludes(void) const;
    size_t  countOfExcludes(void) const;
    FlightSeatTypeJSON *  elementOfExcludes(size_t element_num);
    const FlightSeatTypeJSON *  elementOfExcludes(size_t element_num) const;
    std::vector< FlightSeatTypeJSON * >  getExcludes(void);
    const std::vector< FlightSeatTypeJSON * >  getExcludes(void) const;
    ...
    virtual size_t extraFlightSeatPreferencesComponentCount(void) const
      {
        assert(extraKeys.size() == extraValues.size());
        return extraKeys.size();
      }
    virtual const char *extraFlightSeatPreferencesComponentKey(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraKeys[component_num].c_str();
      }
    virtual JSONValue *extraFlightSeatPreferencesComponentValue(size_t component_num)
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual const JSONValue *extraFlightSeatPreferencesComponentValue(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual JSONValue *extraFlightSeatPreferencesLookup(const char *field_name)
      {
    ...
    virtual const JSONValue *extraFlightSeatPreferencesLookup(const char *field_name) const
      {
        JSONValue *result = (JSONValue *)(lookup_in_string_index(extraIndex, field_name));
        if (result != NULL)
            result->add_reference();
    ...
    void appendIncludes(FlightSeatTypeJSON * to_append)
      {
        if (!flagHasIncludes)
          {
            flagHasIncludes = true;
    ...
    void appendIncludes(FlightSeatTypeJSON::TypeValue new_value)
      {
    ...
    void appendIncludes(const char *chars)
      {
        ...
        FlightSeatTypeJSON::TypeValue new_value;
        if (known == FlightSeatTypeJSON::Value__none)
          {
    ...
    void appendExcludes(FlightSeatTypeJSON * to_append)
      {
        if (!flagHasExcludes)
          {
            flagHasExcludes = true;
    ...
    void appendExcludes(FlightSeatTypeJSON::TypeValue new_value)
      {
    ...
    virtual void extraFlightSeatPreferencesAppendPair(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
    ...
    virtual void extraFlightSeatPreferencesSetField(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
        assert(new_component != NULL);
    ...
    static FlightSeatPreferencesJSON *from_json(JSONValue *json_value, bool ignore_extras = false);
    static FlightSeatPreferencesJSON *from_text(const char *text, bool ignore_extras = false)
      {
        FlightSeatPreferencesJSON *result;
          {
            ...
            parse_json_value(text, "Text for FlightSeatPreferencesJSON", &generator);
    ...
    static FlightSeatPreferencesJSON *from_file(FILE *fp, const char *file_name, bool ignore_extras = false)
      {
        FlightSeatPreferencesJSON *result;
          {
            JSONHoldingGenerator<Generator, RCHandle<FlightSeatPreferencesJSON>, FlightSeatPreferencesJSON *, bool> generator("Type FlightSeatPreferences", ignore_extras);
    ...
    class Generator : public JSONObjectGenerator
      {
      private:
        JSONHoldingArrayGenerator<FlightSeatTypeJSON::Generator, RCHandle<FlightSeatTypeJSON>, FlightSeatTypeJSON *, bool > fieldGeneratorIncludes;
        JSONHoldingArrayGenerator<FlightSeatTypeJSON::Generator, RCHandle<FlightSeatTypeJSON>, FlightSeatTypeJSON *, bool > fieldGeneratorExcludes;
      ...
      protected:
        ...
        void finish(void)
          {
            ...
            assert(result != NULL);
            RCHandle<FlightSeatPreferencesJSON> result_holder = result;
            finish(result);
            size_t extra_count = unknownFieldGenerator.field_names.size();
            assert(extra_count == unknownFieldGenerator.field_values.size());
            for (size_t extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result->extraFlightSeatPreferencesAppendPair(unknownFieldGenerator.field_names[extra_num].c_str(), unknownFieldGenerator.field_values[extra_num].referenced());
              }
        ...
        void finish(FlightSeatPreferencesJSON *result)
          {
        ...
        virtual void handle_result(FlightSeatPreferencesJSON *new_result) = 0;
      ...
      public:
        Generator(bool ignore_extras = false) : fieldGeneratorIncludes("field \"Includes\" of the FlightSeatPreferences class", ignore_extras), fieldGeneratorExcludes("field \"Excludes\" of the FlightSeatPreferences class", ignore_extras), fieldGeneratorDefaultForOthers("field \"DefaultForOthers\" of the FlightSeatPreferences class", ignore_extras), unknownFieldGenerator(ignore_extras)
          {
...
#endif /* FLIGHTSEATPREFERENCESJSON_H */
