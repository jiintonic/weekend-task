/* file "ShowWeatherForecastHourlyInformationNuggetJSON.h" */

/* Generated automatically by Classy JSON. */


#ifndef SHOWWEATHERFORECASTHOURLYINFORMATIONNUGGETJSON_H
#define SHOWWEATHERFORECASTHOURLYINFORMATIONNUGGETJSON_H
...
class ShowWeatherForecastHourlyInformationNuggetJSON : public WeatherInformationNuggetJSON
  {
  public:
  ...
  private:
    ...
    ShowWeatherForecastHourlyInformationNuggetJSON(const ShowWeatherForecastHourlyInformationNuggetJSON &);
    ShowWeatherForecastHourlyInformationNuggetJSON & operator=(const ShowWeatherForecastHourlyInformationNuggetJSON &other);
  ...
  public:
    ShowWeatherForecastHourlyInformationNuggetJSON(void);
    virtual ~ShowWeatherForecastHourlyInformationNuggetJSON(void);
    ...
    virtual size_t extraShowWeatherForecastHourlyInformationNuggetComponentCount(void) const
      {
        assert(extraKeys.size() == extraValues.size());
        return extraKeys.size();
      }
    virtual const char *extraShowWeatherForecastHourlyInformationNuggetComponentKey(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraKeys[component_num].c_str();
      }
    virtual JSONValue *extraShowWeatherForecastHourlyInformationNuggetComponentValue(size_t component_num)
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual const JSONValue *extraShowWeatherForecastHourlyInformationNuggetComponentValue(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual JSONValue *extraShowWeatherForecastHourlyInformationNuggetLookup(const char *field_name)
      {
        JSONValue *result = (JSONValue *)(lookup_in_string_index(extraIndex, field_name));
        if (result != NULL)
            result->add_reference();
    ...
    virtual const JSONValue *extraShowWeatherForecastHourlyInformationNuggetLookup(const char *field_name) const
      {
        JSONValue *result = (JSONValue *)(lookup_in_string_index(extraIndex, field_name));
        if (result != NULL)
            result->add_reference();
        ...
        switch ((unsigned char)(field_name[0]))
          {
            ...
            case 'E':
                ...
                break;
            case 'H':
                if (strcmp(&(field_name[1]), "ourlyForecasts") == 0)
    ...
    virtual void extraShowWeatherForecastHourlyInformationNuggetAppendPair(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
        assert(new_component != NULL);
    ...
    virtual void extraShowWeatherForecastHourlyInformationNuggetSetField(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
        assert(new_component != NULL);
        ...
        switch ((unsigned char)(key[0]))
          {
            ...
            case 'E':
                ...
                break;
            case 'H':
                if (strcmp(&(key[1]), "ourlyForecasts") == 0)
                    {
                ...
                switch ((unsigned char)(key[1]))
                  {
                    case 'e':
                        ...
                        break;
                    case 't':
                        if (strcmp(&(key[2]), "artDateAndTime") == 0)
                            {
    ...
    static ShowWeatherForecastHourlyInformationNuggetJSON *from_json(JSONValue *json_value, bool ignore_extras = false);
    static ShowWeatherForecastHourlyInformationNuggetJSON *from_text(const char *text, bool ignore_extras = false)
      {
        ShowWeatherForecastHourlyInformationNuggetJSON *result;
          {
            ...
            parse_json_value(text, "Text for ShowWeatherForecastHourlyInformationNuggetJSON", &generator);
            assert(generator.have_value);
            result = generator.value.referenced();
            result->add_reference();
          };
    ...
    static ShowWeatherForecastHourlyInformationNuggetJSON *from_file(FILE *fp, const char *file_name, bool ignore_extras = false)
      {
        ShowWeatherForecastHourlyInformationNuggetJSON *result;
          {
            JSONHoldingGenerator<Generator, RCHandle<ShowWeatherForecastHourlyInformationNuggetJSON>, ShowWeatherForecastHourlyInformationNuggetJSON *, bool> generator("Type ShowWeatherForecastHourlyInformationNugget", ignore_extras);
    ...
    class FieldGeneratorRequestedAttributeAction : public JSONStringGenerator
      ...
      protected:
        ...
        void finish(void)
          {
            if (!(strcmp(getWeatherInformationNuggetJSONKey().c_str(), "ShowWeatherForecastHourly") == 0))
                throw("The key field has a value other than `ShowWeatherForecastHourly'.");
            ShowWeatherForecastHourlyInformationNuggetJSON *result = new ShowWeatherForecastHourlyInformationNuggetJSON();
            assert(result != NULL);
            RCHandle<ShowWeatherForecastHourlyInformationNuggetJSON> result_holder = result;
            finish(result);
            size_t extra_count = unknownFieldGenerator.field_names.size();
            assert(extra_count == unknownFieldGenerator.field_values.size());
            for (size_t extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result->extraShowWeatherForecastHourlyInformationNuggetAppendPair(unknownFieldGenerator.field_names[extra_num].c_str(), unknownFieldGenerator.field_values[extra_num].referenced());
              }
            unknownFieldGenerator.field_names.clear();
            unknownFieldGenerator.field_values.clear();
            destroy_string_index(unknownFieldGenerator.index);
        ...
        void finish(ShowWeatherForecastHourlyInformationNuggetJSON *result)
          {
        ...
        virtual void handle_result(ShowWeatherForecastHourlyInformationNuggetJSON *new_result) = 0;
        virtual JSONHandler *start_known_field(const char *field_name)
          {
            switch ((unsigned char)(field_name[0]))
              {
      ...
      public:
        Generator(bool ignore_extras = false) : WeatherInformationNuggetJSON::Generator(ignore_extras), fieldGeneratorAttribution("field \"Attribution\" of the ShowWeatherForecastHourlyInformationNugget class", ignore_extras), fieldGeneratorLocation("field \"Location\" of the ShowWeatherForecastHourlyInformationNugget class", ignore_extras), fieldGeneratorAlerts("field \"Alerts\" of the ShowWeatherForecastHourlyInformationNugget class", ignore_extras), fieldGeneratorRequestedAttribute("field \"RequestedAttribute\" of the ShowWeatherForecastHourlyInformationNugget class"), fieldGeneratorRequestedAttributeAction("field \"RequestedAttributeAction\" of the ShowWeatherForecastHourlyInformationNugget class"), fieldGeneratorIsSearchQuery("field \"IsSearchQuery\" of the ShowWeatherForecastHourlyInformationNugget class"), fieldGeneratorIsYesNoQuery("field \"IsYesNoQuery\" of the ShowWeatherForecastHourlyInformationNugget class"), fieldGeneratorSearchResults("field \"SearchResults\" of the ShowWeatherForecastHourlyInformationNugget class", ignore_extras), fieldGeneratorStartDateAndTime("field \"StartDateAndTime\" of the ShowWeatherForecastHourlyInformationNugget class", ignore_extras), fieldGeneratorEndDateAndTime("field \"EndDateAndTime\" of the ShowWeatherForecastHourlyInformationNugget class", ignore_extras), fieldGeneratorDailyForecasts("field \"DailyForecasts\" of the ShowWeatherForecastHourlyInformationNugget class", ignore_extras), fieldGeneratorHourlyForecasts("field \"HourlyForecasts\" of the ShowWeatherForecastHourlyInformationNugget class", ignore_extras), fieldGeneratorPlanner("field \"Planner\" of the ShowWeatherForecastHourlyInformationNugget class", ignore_extras), fieldGeneratorCurrentConditions("field \"CurrentConditions\" of the ShowWeatherForecastHourlyInformationNugget class", ignore_extras), unknownFieldGenerator(ignore_extras)
          {
...
#endif /* SHOWWEATHERFORECASTHOURLYINFORMATIONNUGGETJSON_H */
