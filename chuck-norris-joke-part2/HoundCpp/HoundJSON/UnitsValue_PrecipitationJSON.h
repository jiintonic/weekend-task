/* file "UnitsValue_PrecipitationJSON.h" */

/* Generated automatically by Classy JSON. */


#ifndef UNITSVALUE_PRECIPITATIONJSON_H
#define UNITSVALUE_PRECIPITATIONJSON_H
...
class UnitsValue_PrecipitationJSON : public ReferenceCounted
  {
  private:
    bool flagHasFormat;
    ...
    UnitsValue_PrecipitationJSON(const UnitsValue_PrecipitationJSON &);
    UnitsValue_PrecipitationJSON & operator=(const UnitsValue_PrecipitationJSON &other);
  ...
  public:
    UnitsValue_PrecipitationJSON(void);
    virtual ~UnitsValue_PrecipitationJSON(void);
    ...
    virtual size_t extraUnitsValue_PrecipitationComponentCount(void) const
      {
        assert(extraKeys.size() == extraValues.size());
        return extraKeys.size();
      }
    virtual const char *extraUnitsValue_PrecipitationComponentKey(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraKeys[component_num].c_str();
      }
    virtual JSONValue *extraUnitsValue_PrecipitationComponentValue(size_t component_num)
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual const JSONValue *extraUnitsValue_PrecipitationComponentValue(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual JSONValue *extraUnitsValue_PrecipitationLookup(const char *field_name)
      {
    ...
    virtual const JSONValue *extraUnitsValue_PrecipitationLookup(const char *field_name) const
      {
        JSONValue *result = (JSONValue *)(lookup_in_string_index(extraIndex, field_name));
        if (result != NULL)
            result->add_reference();
    ...
    void setValue(double new_value)
      {
        flagHasValue = true;
        if (new_value < 0)
            throw("The value for field Value of UnitsValue_PrecipitationJSON is less than the lower bound (0) for that field.");
    ...
    void setValueText(std::string new_value)
      {
        ...
        if (!(JSONWriter::is_valid_number_format(new_value.c_str())))
            throw("The text value for field Value of UnitsValue_PrecipitationJSON is not a valid number.");
    ...
    virtual void extraUnitsValue_PrecipitationAppendPair(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
    ...
    virtual void extraUnitsValue_PrecipitationSetField(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
        assert(new_component != NULL);
    ...
    static UnitsValue_PrecipitationJSON *from_json(JSONValue *json_value, bool ignore_extras = false);
    static UnitsValue_PrecipitationJSON *from_text(const char *text, bool ignore_extras = false)
      {
        UnitsValue_PrecipitationJSON *result;
          {
            ...
            parse_json_value(text, "Text for UnitsValue_PrecipitationJSON", &generator);
    ...
    static UnitsValue_PrecipitationJSON *from_file(FILE *fp, const char *file_name, bool ignore_extras = false)
      {
        UnitsValue_PrecipitationJSON *result;
          {
            JSONHoldingGenerator<Generator, RCHandle<UnitsValue_PrecipitationJSON>, UnitsValue_PrecipitationJSON *, bool> generator("Type UnitsValue_Precipitation", ignore_extras);
    ...
    class Generator : public JSONObjectGenerator
      ...
      protected:
        ...
        void finish(void)
          {
            ...
            assert(result != NULL);
            RCHandle<UnitsValue_PrecipitationJSON> result_holder = result;
            finish(result);
            size_t extra_count = unknownFieldGenerator.field_names.size();
            assert(extra_count == unknownFieldGenerator.field_values.size());
            for (size_t extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result->extraUnitsValue_PrecipitationAppendPair(unknownFieldGenerator.field_names[extra_num].c_str(), unknownFieldGenerator.field_values[extra_num].referenced());
              }
        ...
        void finish(UnitsValue_PrecipitationJSON *result)
          {
        ...
        virtual void handle_result(UnitsValue_PrecipitationJSON *new_result) = 0;
      ...
      public:
        Generator(bool ignore_extras = false) : fieldGeneratorFormat("field \"Format\" of the UnitsValue_Precipitation class"), fieldGeneratorUnits("field \"Units\" of the UnitsValue_Precipitation class"), fieldGeneratorWrittenUnits("field \"WrittenUnits\" of the UnitsValue_Precipitation class"), fieldGeneratorSpokenUnits("field \"SpokenUnits\" of the UnitsValue_Precipitation class"), fieldGeneratorValue("field \"Value\" of the UnitsValue_Precipitation class"), unknownFieldGenerator(ignore_extras)
          {
...
#endif /* UNITSVALUE_PRECIPITATIONJSON_H */
