/* file "HomeAutomationGroupParsingItemJSON.h" */

/* Generated automatically by Classy JSON. */


#ifndef HOMEAUTOMATIONGROUPPARSINGITEMJSON_H
#define HOMEAUTOMATIONGROUPPARSINGITEMJSON_H
...
class HomeAutomationGroupParsingItemJSON : public ReferenceCounted
  {
  private:
    bool flagHasName;
    ...
    HomeAutomationGroupParsingItemJSON(const HomeAutomationGroupParsingItemJSON &);
    HomeAutomationGroupParsingItemJSON & operator=(const HomeAutomationGroupParsingItemJSON &other);
  ...
  public:
    HomeAutomationGroupParsingItemJSON(void);
    virtual ~HomeAutomationGroupParsingItemJSON(void);
    ...
    virtual size_t extraHomeAutomationGroupParsingItemComponentCount(void) const
      {
        assert(extraKeys.size() == extraValues.size());
        return extraKeys.size();
      }
    virtual const char *extraHomeAutomationGroupParsingItemComponentKey(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraKeys[component_num].c_str();
      }
    virtual JSONValue *extraHomeAutomationGroupParsingItemComponentValue(size_t component_num)
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual const JSONValue *extraHomeAutomationGroupParsingItemComponentValue(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual JSONValue *extraHomeAutomationGroupParsingItemLookup(const char *field_name)
      {
    ...
    virtual const JSONValue *extraHomeAutomationGroupParsingItemLookup(const char *field_name) const
      {
        JSONValue *result = (JSONValue *)(lookup_in_string_index(extraIndex, field_name));
        if (result != NULL)
            result->add_reference();
    ...
    virtual void extraHomeAutomationGroupParsingItemAppendPair(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
    ...
    virtual void extraHomeAutomationGroupParsingItemSetField(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
        assert(new_component != NULL);
    ...
    static HomeAutomationGroupParsingItemJSON *from_json(JSONValue *json_value, bool ignore_extras = false);
    static HomeAutomationGroupParsingItemJSON *from_text(const char *text, bool ignore_extras = false)
      {
        HomeAutomationGroupParsingItemJSON *result;
          {
            ...
            parse_json_value(text, "Text for HomeAutomationGroupParsingItemJSON", &generator);
    ...
    static HomeAutomationGroupParsingItemJSON *from_file(FILE *fp, const char *file_name, bool ignore_extras = false)
      {
        HomeAutomationGroupParsingItemJSON *result;
          {
            JSONHoldingGenerator<Generator, RCHandle<HomeAutomationGroupParsingItemJSON>, HomeAutomationGroupParsingItemJSON *, bool> generator("Type HomeAutomationGroupParsingItem", ignore_extras);
    ...
    class Generator : public JSONObjectGenerator
      ...
      protected:
        ...
        void finish(void)
          {
            ...
            assert(result != NULL);
            RCHandle<HomeAutomationGroupParsingItemJSON> result_holder = result;
            finish(result);
            size_t extra_count = unknownFieldGenerator.field_names.size();
            assert(extra_count == unknownFieldGenerator.field_values.size());
            for (size_t extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result->extraHomeAutomationGroupParsingItemAppendPair(unknownFieldGenerator.field_names[extra_num].c_str(), unknownFieldGenerator.field_values[extra_num].referenced());
              }
        ...
        void finish(HomeAutomationGroupParsingItemJSON *result)
          {
        ...
        virtual void handle_result(HomeAutomationGroupParsingItemJSON *new_result) = 0;
      ...
      public:
        Generator(bool ignore_extras = false) : fieldGeneratorName("field \"Name\" of the HomeAutomationGroupParsingItem class"), fieldGeneratorActualNames("field \"ActualNames\" of the HomeAutomationGroupParsingItem class"), fieldGeneratorSpokenPrefix("field \"SpokenPrefix\" of the HomeAutomationGroupParsingItem class"), unknownFieldGenerator(ignore_extras)
          {
...
#endif /* HOMEAUTOMATIONGROUPPARSINGITEMJSON_H */
