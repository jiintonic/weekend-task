...
#ifndef EMOTIONJSON_H
#define EMOTIONJSON_H
...
class EmotionJSON : public ReferenceCounted
  {
  public:
    enum TypeValue
      {
  ...
  private:
    ...
    EmotionJSON(const EmotionJSON &);
    EmotionJSON & operator=(const EmotionJSON &other);
  ...
  public:
    EmotionJSON(void);
    EmotionJSON(TypeValue init_value);
    EmotionJSON(const char *init_value);
    EmotionJSON(std::string init_value);
    virtual ~EmotionJSON(void);
    ...
    static EmotionJSON *from_json(JSONValue *json_value, bool ignore_extras = false);
    static EmotionJSON *from_text(const char *text, bool ignore_extras = false)
      {
        EmotionJSON *result;
          {
            JSONHoldingGenerator<Generator, RCHandle<EmotionJSON>, EmotionJSON *, bool> generator("Type Emotion", ignore_extras);
            parse_json_value(text, "Text for EmotionJSON", &generator);
    ...
    static EmotionJSON *from_file(FILE *fp, const char *file_name, bool ignore_extras = false)
      {
        EmotionJSON *result;
          {
            JSONHoldingGenerator<Generator, RCHandle<EmotionJSON>, EmotionJSON *, bool> generator("Type Emotion", ignore_extras);
    ...
    class Generator : public FieldGeneratorValue
      ...
      protected:
        ...
        virtual void handle_result(EmotionJSON *new_result) = 0;
