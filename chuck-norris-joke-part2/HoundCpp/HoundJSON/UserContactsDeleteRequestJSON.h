/* file "UserContactsDeleteRequestJSON.h" */

/* Generated automatically by Classy JSON. */


#ifndef USERCONTACTSDELETEREQUESTJSON_H
#define USERCONTACTSDELETEREQUESTJSON_H
...
class UserContactsDeleteRequestJSON : public UserContactsRequestJSON
  {
  private:
    ...
    UserContactsDeleteRequestJSON(const UserContactsDeleteRequestJSON &);
    UserContactsDeleteRequestJSON & operator=(const UserContactsDeleteRequestJSON &other);
  ...
  public:
    UserContactsDeleteRequestJSON(void);
    virtual ~UserContactsDeleteRequestJSON(void);
    ...
    virtual size_t extraUserContactsDeleteRequestComponentCount(void) const
      {
        assert(extraKeys.size() == extraValues.size());
        return extraKeys.size();
      }
    virtual const char *extraUserContactsDeleteRequestComponentKey(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraKeys[component_num].c_str();
      }
    virtual JSONValue *extraUserContactsDeleteRequestComponentValue(size_t component_num)
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual const JSONValue *extraUserContactsDeleteRequestComponentValue(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual JSONValue *extraUserContactsDeleteRequestLookup(const char *field_name)
      {
    ...
    virtual const JSONValue *extraUserContactsDeleteRequestLookup(const char *field_name) const
      {
        JSONValue *result = (JSONValue *)(lookup_in_string_index(extraIndex, field_name));
        if (result != NULL)
            result->add_reference();
    ...
    virtual void extraUserContactsDeleteRequestAppendPair(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
    ...
    virtual void extraUserContactsDeleteRequestSetField(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
        assert(new_component != NULL);
    ...
    static UserContactsDeleteRequestJSON *from_json(JSONValue *json_value, bool ignore_extras = false);
    static UserContactsDeleteRequestJSON *from_text(const char *text, bool ignore_extras = false)
      {
        UserContactsDeleteRequestJSON *result;
          {
            ...
            parse_json_value(text, "Text for UserContactsDeleteRequestJSON", &generator);
    ...
    static UserContactsDeleteRequestJSON *from_file(FILE *fp, const char *file_name, bool ignore_extras = false)
      {
        UserContactsDeleteRequestJSON *result;
          {
            JSONHoldingGenerator<Generator, RCHandle<UserContactsDeleteRequestJSON>, UserContactsDeleteRequestJSON *, bool> generator("Type UserContactsDeleteRequest", ignore_extras);
    ...
    class Generator : public UserContactsRequestJSON::Generator
      ...
      protected:
        ...
        void finish(void)
          {
            if (!(strcmp(getUserContactsRequestJSONKey().c_str(), "Delete") == 0))
                throw("The key field has a value other than `Delete'.");
            UserContactsDeleteRequestJSON *result = new UserContactsDeleteRequestJSON();
            assert(result != NULL);
            RCHandle<UserContactsDeleteRequestJSON> result_holder = result;
            finish(result);
            size_t extra_count = unknownFieldGenerator.field_names.size();
            assert(extra_count == unknownFieldGenerator.field_values.size());
            for (size_t extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result->extraUserContactsDeleteRequestAppendPair(unknownFieldGenerator.field_names[extra_num].c_str(), unknownFieldGenerator.field_values[extra_num].referenced());
              }
        ...
        void finish(UserContactsDeleteRequestJSON *result)
          {
        ...
        virtual void handle_result(UserContactsDeleteRequestJSON *new_result) = 0;
      ...
      public:
        Generator(bool ignore_extras = false) : UserContactsRequestJSON::Generator(ignore_extras), fieldGeneratorKeyFieldName("field \"KeyFieldName\" of the UserContactsDeleteRequest class"), fieldGeneratorMatchValue("field \"MatchValue\" of the UserContactsDeleteRequest class"), unknownFieldGenerator(ignore_extras)
          {
...
#endif /* USERCONTACTSDELETEREQUESTJSON_H */
