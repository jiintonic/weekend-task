/* file "ShowWhichContactAmbiguousCommandJSON.h" */

/* Generated automatically by Classy JSON. */


#ifndef SHOWWHICHCONTACTAMBIGUOUSCOMMANDJSON_H
#define SHOWWHICHCONTACTAMBIGUOUSCOMMANDJSON_H
...
class ShowWhichContactAmbiguousCommandJSON : public DisambiguateCommandJSON
  {
  private:
    bool flagHasChoices;
    ...
    ShowWhichContactAmbiguousCommandJSON(const ShowWhichContactAmbiguousCommandJSON &);
    ShowWhichContactAmbiguousCommandJSON & operator=(const ShowWhichContactAmbiguousCommandJSON &other);
  ...
  public:
    ShowWhichContactAmbiguousCommandJSON(void);
    virtual ~ShowWhichContactAmbiguousCommandJSON(void);
    ...
    virtual size_t extraShowWhichContactAmbiguousCommandComponentCount(void) const
      {
        assert(extraKeys.size() == extraValues.size());
        return extraKeys.size();
      }
    virtual const char *extraShowWhichContactAmbiguousCommandComponentKey(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraKeys[component_num].c_str();
      }
    virtual JSONValue *extraShowWhichContactAmbiguousCommandComponentValue(size_t component_num)
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual const JSONValue *extraShowWhichContactAmbiguousCommandComponentValue(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual JSONValue *extraShowWhichContactAmbiguousCommandLookup(const char *field_name)
      {
    ...
    virtual const JSONValue *extraShowWhichContactAmbiguousCommandLookup(const char *field_name) const
      {
        JSONValue *result = (JSONValue *)(lookup_in_string_index(extraIndex, field_name));
        if (result != NULL)
            result->add_reference();
    ...
    virtual void extraShowWhichContactAmbiguousCommandAppendPair(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
    ...
    virtual void extraShowWhichContactAmbiguousCommandSetField(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
        assert(new_component != NULL);
    ...
    static ShowWhichContactAmbiguousCommandJSON *from_json(JSONValue *json_value, bool ignore_extras = false);
    static ShowWhichContactAmbiguousCommandJSON *from_text(const char *text, bool ignore_extras = false)
      {
        ShowWhichContactAmbiguousCommandJSON *result;
          {
            ...
            parse_json_value(text, "Text for ShowWhichContactAmbiguousCommandJSON", &generator);
    ...
    static ShowWhichContactAmbiguousCommandJSON *from_file(FILE *fp, const char *file_name, bool ignore_extras = false)
      {
        ShowWhichContactAmbiguousCommandJSON *result;
          {
            JSONHoldingGenerator<Generator, RCHandle<ShowWhichContactAmbiguousCommandJSON>, ShowWhichContactAmbiguousCommandJSON *, bool> generator("Type ShowWhichContactAmbiguousCommand", ignore_extras);
    ...
    class Generator : public DisambiguateCommandJSON::Generator
      ...
      protected:
        ...
        void finish(void)
          {
            if (!(strcmp(getDisambiguateCommandJSONKey().c_str(), "ShowWhichContactAmbiguous") == 0))
                throw("The key field has a value other than `ShowWhichContactAmbiguous'.");
            ShowWhichContactAmbiguousCommandJSON *result = new ShowWhichContactAmbiguousCommandJSON();
            assert(result != NULL);
            RCHandle<ShowWhichContactAmbiguousCommandJSON> result_holder = result;
            finish(result);
            size_t extra_count = unknownFieldGenerator.field_names.size();
            assert(extra_count == unknownFieldGenerator.field_values.size());
            for (size_t extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result->extraShowWhichContactAmbiguousCommandAppendPair(unknownFieldGenerator.field_names[extra_num].c_str(), unknownFieldGenerator.field_values[extra_num].referenced());
              }
        ...
        void finish(ShowWhichContactAmbiguousCommandJSON *result)
          {
        ...
        virtual void handle_result(ShowWhichContactAmbiguousCommandJSON *new_result) = 0;
      ...
      public:
        Generator(bool ignore_extras = false) : DisambiguateCommandJSON::Generator(ignore_extras), fieldGeneratorChoices("field \"Choices\" of the ShowWhichContactAmbiguousCommand class", ignore_extras), fieldGeneratorUserSpecifiedName("field \"UserSpecifiedName\" of the ShowWhichContactAmbiguousCommand class"), unknownFieldGenerator(ignore_extras)
          {
...
#endif /* SHOWWHICHCONTACTAMBIGUOUSCOMMANDJSON_H */
