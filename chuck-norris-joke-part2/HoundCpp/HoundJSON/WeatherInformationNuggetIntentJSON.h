/* file "WeatherInformationNuggetIntentJSON.h" */

/* Generated automatically by Classy JSON. */


#ifndef WEATHERINFORMATIONNUGGETINTENTJSON_H
#define WEATHERINFORMATIONNUGGETINTENTJSON_H
...
class WeatherInformationNuggetIntentJSON : public InformationNuggetIntentJSON
  {
  public:
  ...
  private:
    ...
    WeatherInformationNuggetIntentJSON(const WeatherInformationNuggetIntentJSON &);
    WeatherInformationNuggetIntentJSON & operator=(const WeatherInformationNuggetIntentJSON &other);
  ...
  public:
    WeatherInformationNuggetIntentJSON(void);
    virtual ~WeatherInformationNuggetIntentJSON(void);
    ...
    virtual size_t extraWeatherInformationNuggetIntentComponentCount(void) const
      {
        assert(extraKeys.size() == extraValues.size());
        return extraKeys.size();
      }
    virtual const char *extraWeatherInformationNuggetIntentComponentKey(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraKeys[component_num].c_str();
      }
    virtual JSONValue *extraWeatherInformationNuggetIntentComponentValue(size_t component_num)
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual const JSONValue *extraWeatherInformationNuggetIntentComponentValue(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual JSONValue *extraWeatherInformationNuggetIntentLookup(const char *field_name)
      {
    ...
    virtual const JSONValue *extraWeatherInformationNuggetIntentLookup(const char *field_name) const
      {
        JSONValue *result = (JSONValue *)(lookup_in_string_index(extraIndex, field_name));
        if (result != NULL)
            result->add_reference();
    ...
    virtual void extraWeatherInformationNuggetIntentAppendPair(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
    ...
    virtual void extraWeatherInformationNuggetIntentSetField(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
        assert(new_component != NULL);
    ...
    static WeatherInformationNuggetIntentJSON *from_json(JSONValue *json_value, bool ignore_extras = false);
    static WeatherInformationNuggetIntentJSON *from_text(const char *text, bool ignore_extras = false)
      {
        WeatherInformationNuggetIntentJSON *result;
          {
            ...
            parse_json_value(text, "Text for WeatherInformationNuggetIntentJSON", &generator);
    ...
    static WeatherInformationNuggetIntentJSON *from_file(FILE *fp, const char *file_name, bool ignore_extras = false)
      {
        WeatherInformationNuggetIntentJSON *result;
          {
            JSONHoldingGenerator<Generator, RCHandle<WeatherInformationNuggetIntentJSON>, WeatherInformationNuggetIntentJSON *, bool> generator("Type WeatherInformationNuggetIntent", ignore_extras);
    ...
    class FieldGeneratorRequestedAttributeAction : public JSONStringGenerator
      ...
      protected:
        ...
        void finish(void)
          {
            if (!(strcmp(getInformationNuggetIntentJSONKey().c_str(), "Weather") == 0))
            ...
            assert(result != NULL);
            RCHandle<WeatherInformationNuggetIntentJSON> result_holder = result;
            finish(result);
            size_t extra_count = unknownFieldGenerator.field_names.size();
            assert(extra_count == unknownFieldGenerator.field_values.size());
            for (size_t extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result->extraWeatherInformationNuggetIntentAppendPair(unknownFieldGenerator.field_names[extra_num].c_str(), unknownFieldGenerator.field_values[extra_num].referenced());
              }
        ...
        void finish(WeatherInformationNuggetIntentJSON *result)
          {
        ...
        virtual void handle_result(WeatherInformationNuggetIntentJSON *new_result) = 0;
      ...
      public:
        Generator(bool ignore_extras = false) : InformationNuggetIntentJSON::Generator(ignore_extras), fieldGeneratorWeatherIntentKind("field \"WeatherIntentKind\" of the WeatherInformationNuggetIntent class"), fieldGeneratorWeatherQueryType("field \"WeatherQueryType\" of the WeatherInformationNuggetIntent class"), fieldGeneratorRequestedAttribute("field \"RequestedAttribute\" of the WeatherInformationNuggetIntent class"), fieldGeneratorRequestedAttributeAction("field \"RequestedAttributeAction\" of the WeatherInformationNuggetIntent class"), fieldGeneratorIsSearchQuery("field \"IsSearchQuery\" of the WeatherInformationNuggetIntent class"), fieldGeneratorMapLocation("field \"MapLocation\" of the WeatherInformationNuggetIntent class", ignore_extras), fieldGeneratorDateTimeRange("field \"DateTimeRange\" of the WeatherInformationNuggetIntent class", ignore_extras), fieldGeneratorUnits("field \"Units\" of the WeatherInformationNuggetIntent class"), fieldGeneratorIsYesNoQuery("field \"IsYesNoQuery\" of the WeatherInformationNuggetIntent class"), fieldGeneratorDailyForecastExplicitlyRequested("field \"DailyForecastExplicitlyRequested\" of the WeatherInformationNuggetIntent class"), fieldGeneratorHourlyForecastExplicitlyRequested("field \"HourlyForecastExplicitlyRequested\" of the WeatherInformationNuggetIntent class"), fieldGeneratorDisplayDaily("field \"DisplayDaily\" of the WeatherInformationNuggetIntent class"), fieldGeneratorDisplayHourly("field \"DisplayHourly\" of the WeatherInformationNuggetIntent class"), unknownFieldGenerator(ignore_extras)
          {
...
#endif /* WEATHERINFORMATIONNUGGETINTENTJSON_H */
