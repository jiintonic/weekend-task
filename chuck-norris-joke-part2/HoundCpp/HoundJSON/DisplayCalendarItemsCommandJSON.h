/* file "DisplayCalendarItemsCommandJSON.h" */

/* Generated automatically by Classy JSON. */


#ifndef DISPLAYCALENDARITEMSCOMMANDJSON_H
#define DISPLAYCALENDARITEMSCOMMANDJSON_H
...
class DisplayCalendarItemsCommandJSON : public CalendarCommandJSON
  {
  public:
  ...
  private:
    ...
    DisplayCalendarItemsCommandJSON(const DisplayCalendarItemsCommandJSON &);
    DisplayCalendarItemsCommandJSON & operator=(const DisplayCalendarItemsCommandJSON &other);
  ...
  public:
    DisplayCalendarItemsCommandJSON(void);
    virtual ~DisplayCalendarItemsCommandJSON(void);
    ...
    virtual size_t extraDisplayCalendarItemsCommandComponentCount(void) const
      {
        assert(extraKeys.size() == extraValues.size());
        return extraKeys.size();
      }
    virtual const char *extraDisplayCalendarItemsCommandComponentKey(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraKeys[component_num].c_str();
      }
    virtual JSONValue *extraDisplayCalendarItemsCommandComponentValue(size_t component_num)
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual const JSONValue *extraDisplayCalendarItemsCommandComponentValue(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual JSONValue *extraDisplayCalendarItemsCommandLookup(const char *field_name)
      {
        JSONValue *result = (JSONValue *)(lookup_in_string_index(extraIndex, field_name));
        if (result != NULL)
            result->add_reference();
    ...
    virtual const JSONValue *extraDisplayCalendarItemsCommandLookup(const char *field_name) const
      {
        JSONValue *result = (JSONValue *)(lookup_in_string_index(extraIndex, field_name));
        if (result != NULL)
            result->add_reference();
    ...
    virtual void extraDisplayCalendarItemsCommandAppendPair(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
        assert(new_component != NULL);
    ...
    virtual void extraDisplayCalendarItemsCommandSetField(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
        assert(new_component != NULL);
    ...
    static DisplayCalendarItemsCommandJSON *from_json(JSONValue *json_value, bool ignore_extras = false);
    static DisplayCalendarItemsCommandJSON *from_text(const char *text, bool ignore_extras = false)
      {
        DisplayCalendarItemsCommandJSON *result;
          {
            ...
            parse_json_value(text, "Text for DisplayCalendarItemsCommandJSON", &generator);
            assert(generator.have_value);
            result = generator.value.referenced();
            result->add_reference();
          };
    ...
    static DisplayCalendarItemsCommandJSON *from_file(FILE *fp, const char *file_name, bool ignore_extras = false)
      {
        DisplayCalendarItemsCommandJSON *result;
          {
            JSONHoldingGenerator<Generator, RCHandle<DisplayCalendarItemsCommandJSON>, DisplayCalendarItemsCommandJSON *, bool> generator("Type DisplayCalendarItemsCommand", ignore_extras);
    ...
    class Generator : public CalendarCommandJSON::Generator
      ...
      protected:
        ...
        void finish(void)
          {
            if (!(strcmp(getCalendarCommandJSONKey().c_str(), "DisplayItems") == 0))
                throw("The key field has a value other than `DisplayItems'.");
            DisplayCalendarItemsCommandJSON *result = new DisplayCalendarItemsCommandJSON();
            assert(result != NULL);
            RCHandle<DisplayCalendarItemsCommandJSON> result_holder = result;
            finish(result);
            size_t extra_count = unknownFieldGenerator.field_names.size();
            assert(extra_count == unknownFieldGenerator.field_values.size());
            for (size_t extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result->extraDisplayCalendarItemsCommandAppendPair(unknownFieldGenerator.field_names[extra_num].c_str(), unknownFieldGenerator.field_values[extra_num].referenced());
              }
            unknownFieldGenerator.field_names.clear();
            unknownFieldGenerator.field_values.clear();
            destroy_string_index(unknownFieldGenerator.index);
        ...
        void finish(DisplayCalendarItemsCommandJSON *result)
          {
            if (fieldGeneratorItemType.have_value)
              {
                result->setItemType(fieldGeneratorItemType.value);
        ...
        virtual void handle_result(DisplayCalendarItemsCommandJSON *new_result) = 0;
        virtual JSONHandler *start_known_field(const char *field_name)
          {
            switch ((unsigned char)(field_name[0]))
              {
      ...
      public:
        Generator(bool ignore_extras = false) : CalendarCommandJSON::Generator(ignore_extras), fieldGeneratorItemType("field \"ItemType\" of the DisplayCalendarItemsCommand class"), fieldGeneratorExactTitle("field \"ExactTitle\" of the DisplayCalendarItemsCommand class"), fieldGeneratorPartialTitle("field \"PartialTitle\" of the DisplayCalendarItemsCommand class"), fieldGeneratorExactLocation("field \"ExactLocation\" of the DisplayCalendarItemsCommand class"), fieldGeneratorPartialLocation("field \"PartialLocation\" of the DisplayCalendarItemsCommand class"), fieldGeneratorStartStart("field \"StartStart\" of the DisplayCalendarItemsCommand class", ignore_extras), fieldGeneratorEndStart("field \"EndStart\" of the DisplayCalendarItemsCommand class", ignore_extras), fieldGeneratorStartEnd("field \"StartEnd\" of the DisplayCalendarItemsCommand class", ignore_extras), fieldGeneratorEndEnd("field \"EndEnd\" of the DisplayCalendarItemsCommand class", ignore_extras), fieldGeneratorNativeData("field \"NativeData\" of the DisplayCalendarItemsCommand class", ignore_extras), unknownFieldGenerator(ignore_extras)
          {
...
#endif /* DISPLAYCALENDARITEMSCOMMANDJSON_H */
