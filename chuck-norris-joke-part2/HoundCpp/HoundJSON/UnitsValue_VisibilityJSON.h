/* file "UnitsValue_VisibilityJSON.h" */

/* Generated automatically by Classy JSON. */


#ifndef UNITSVALUE_VISIBILITYJSON_H
#define UNITSVALUE_VISIBILITYJSON_H
...
class UnitsValue_VisibilityJSON : public ReferenceCounted
  {
  private:
    bool flagHasFormat;
    ...
    UnitsValue_VisibilityJSON(const UnitsValue_VisibilityJSON &);
    UnitsValue_VisibilityJSON & operator=(const UnitsValue_VisibilityJSON &other);
  ...
  public:
    UnitsValue_VisibilityJSON(void);
    virtual ~UnitsValue_VisibilityJSON(void);
    ...
    virtual size_t extraUnitsValue_VisibilityComponentCount(void) const
      {
        assert(extraKeys.size() == extraValues.size());
        return extraKeys.size();
      }
    virtual const char *extraUnitsValue_VisibilityComponentKey(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraKeys[component_num].c_str();
      }
    virtual JSONValue *extraUnitsValue_VisibilityComponentValue(size_t component_num)
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual const JSONValue *extraUnitsValue_VisibilityComponentValue(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual JSONValue *extraUnitsValue_VisibilityLookup(const char *field_name)
      {
    ...
    virtual const JSONValue *extraUnitsValue_VisibilityLookup(const char *field_name) const
      {
        JSONValue *result = (JSONValue *)(lookup_in_string_index(extraIndex, field_name));
        if (result != NULL)
            result->add_reference();
    ...
    void setValue(double new_value)
      {
        flagHasValue = true;
        if (new_value < 0)
            throw("The value for field Value of UnitsValue_VisibilityJSON is less than the lower bound (0) for that field.");
    ...
    void setValueText(std::string new_value)
      {
        ...
        if (!(JSONWriter::is_valid_number_format(new_value.c_str())))
            throw("The text value for field Value of UnitsValue_VisibilityJSON is not a valid number.");
    ...
    virtual void extraUnitsValue_VisibilityAppendPair(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
    ...
    virtual void extraUnitsValue_VisibilitySetField(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
        assert(new_component != NULL);
    ...
    static UnitsValue_VisibilityJSON *from_json(JSONValue *json_value, bool ignore_extras = false);
    static UnitsValue_VisibilityJSON *from_text(const char *text, bool ignore_extras = false)
      {
        UnitsValue_VisibilityJSON *result;
          {
            ...
            parse_json_value(text, "Text for UnitsValue_VisibilityJSON", &generator);
    ...
    static UnitsValue_VisibilityJSON *from_file(FILE *fp, const char *file_name, bool ignore_extras = false)
      {
        UnitsValue_VisibilityJSON *result;
          {
            JSONHoldingGenerator<Generator, RCHandle<UnitsValue_VisibilityJSON>, UnitsValue_VisibilityJSON *, bool> generator("Type UnitsValue_Visibility", ignore_extras);
    ...
    class Generator : public JSONObjectGenerator
      ...
      protected:
        ...
        void finish(void)
          {
            ...
            assert(result != NULL);
            RCHandle<UnitsValue_VisibilityJSON> result_holder = result;
            finish(result);
            size_t extra_count = unknownFieldGenerator.field_names.size();
            assert(extra_count == unknownFieldGenerator.field_values.size());
            for (size_t extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result->extraUnitsValue_VisibilityAppendPair(unknownFieldGenerator.field_names[extra_num].c_str(), unknownFieldGenerator.field_values[extra_num].referenced());
              }
        ...
        void finish(UnitsValue_VisibilityJSON *result)
          {
        ...
        virtual void handle_result(UnitsValue_VisibilityJSON *new_result) = 0;
      ...
      public:
        Generator(bool ignore_extras = false) : fieldGeneratorFormat("field \"Format\" of the UnitsValue_Visibility class"), fieldGeneratorUnits("field \"Units\" of the UnitsValue_Visibility class"), fieldGeneratorWrittenUnits("field \"WrittenUnits\" of the UnitsValue_Visibility class"), fieldGeneratorSpokenUnits("field \"SpokenUnits\" of the UnitsValue_Visibility class"), fieldGeneratorValue("field \"Value\" of the UnitsValue_Visibility class"), unknownFieldGenerator(ignore_extras)
          {
...
#endif /* UNITSVALUE_VISIBILITYJSON_H */
