/* file "DictionaryInformationNuggetJSON.h" */

/* Generated automatically by Classy JSON. */


#ifndef DICTIONARYINFORMATIONNUGGETJSON_H
#define DICTIONARYINFORMATIONNUGGETJSON_H
...
class DictionaryInformationNuggetJSON : public InformationNuggetJSON
  {
  public:
  ...
  private:
    ...
    DictionaryInformationNuggetJSON(const DictionaryInformationNuggetJSON &);
    DictionaryInformationNuggetJSON & operator=(const DictionaryInformationNuggetJSON &other);
  ...
  public:
    DictionaryInformationNuggetJSON(void);
    virtual ~DictionaryInformationNuggetJSON(void);
    ...
    static DictionaryInformationNuggetJSON *from_json(JSONValue *json_value, bool ignore_extras = false);
    static DictionaryInformationNuggetJSON *from_text(const char *text, bool ignore_extras = false)
      {
        DictionaryInformationNuggetJSON *result;
          {
            ...
            parse_json_value(text, "Text for DictionaryInformationNuggetJSON", &generator);
            assert(generator.have_value);
            result = generator.value.referenced();
            result->add_reference();
          };
    ...
    static DictionaryInformationNuggetJSON *from_file(FILE *fp, const char *file_name, bool ignore_extras = false)
      {
        DictionaryInformationNuggetJSON *result;
          {
            JSONHoldingGenerator<Generator, RCHandle<DictionaryInformationNuggetJSON>, DictionaryInformationNuggetJSON *, bool> generator("Type DictionaryInformationNugget", ignore_extras);
    ...
    class Generator : public InformationNuggetJSON::Generator
      ...
      protected:
        ...
        void finish(void)
          {
            if (!(strcmp(getInformationNuggetJSONKey().c_str(), "Dictionary") == 0))
                throw("The key field has a value other than `Dictionary'.");
            DictionaryInformationNuggetJSON *result = new DictionaryInformationNuggetJSON();
            assert(result != NULL);
            RCHandle<DictionaryInformationNuggetJSON> result_holder = result;
            finish(result);
            handle_result(result);
          }
        ...
        void finish(DictionaryInformationNuggetJSON *result)
          {
        ...
        virtual void handle_result(DictionaryInformationNuggetJSON *new_result) = 0;
        virtual JSONHandler *start_known_field(const char *field_name)
          {
            if (strcmp(field_name, "NativeData") == 0)
      ...
      public:
        Generator(bool ignore_extras = false) : InformationNuggetJSON::Generator(ignore_extras), fieldGeneratorNativeData("field \"NativeData\" of the DictionaryInformationNugget class", ignore_extras)
          {
...
#endif /* DICTIONARYINFORMATIONNUGGETJSON_H */
