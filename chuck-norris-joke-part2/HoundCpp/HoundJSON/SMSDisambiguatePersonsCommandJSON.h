/* file "SMSDisambiguatePersonsCommandJSON.h" */

/* Generated automatically by Classy JSON. */


#ifndef SMSDISAMBIGUATEPERSONSCOMMANDJSON_H
#define SMSDISAMBIGUATEPERSONSCOMMANDJSON_H
...
class SMSDisambiguatePersonsCommandJSON : public DisambiguateCommandJSON
  {
  public:
    class TypeNativeDataJSON : public ReferenceCounted
      ...
      private:
        ...
        bool flagHasWhichContactChoices;
        WhichContactChoicesJSON * storeWhichContactChoices;
        ...
        void  fromJSONWhichContactChoices(JSONValue *json_value, bool ignore_extras = false);
      ...
      public:
        ...
        bool  hasWhichContactChoices(void) const;
        WhichContactChoicesJSON *  getWhichContactChoices(void);
        const WhichContactChoicesJSON *  getWhichContactChoices(void) const;
        ...
        void setWhichContactChoices(WhichContactChoicesJSON * new_value)
          {
        ...
        void unsetWhichContactChoices(void)
          {
            if (flagHasWhichContactChoices)
              {
                storeWhichContactChoices->remove_reference();
        ...
        class Generator : public JSONObjectGenerator
          ...
          private:
            ...
            JSONHoldingGenerator<WhichContactChoicesJSON::Generator, RCHandle<WhichContactChoicesJSON>, WhichContactChoicesJSON *, bool > fieldGeneratorWhichContactChoices;
            ...
            void finish(TypeNativeDataJSON *result)
              {
                ...
                if (fieldGeneratorWhichContactChoices.have_value)
                  {
                    result->setWhichContactChoices(fieldGeneratorWhichContactChoices.value.referenced());
                    fieldGeneratorWhichContactChoices.have_value = false;
                  }
                else if (!(result->hasWhichContactChoices()))
                  {
                ...
                switch ((unsigned char)(field_name[0]))
                  {
                    ...
                    case 'W':
                        switch ((unsigned char)(field_name[1]))
                          {
                            case 'h':
                                if (strcmp(&(field_name[2]), "ichContactChoices") == 0)
                                    return &fieldGeneratorWhichContactChoices;
                                break;
                            case 'r':
                                if (strcmp(&(field_name[2]), "ittenBody") == 0)
  ...
  private:
    ...
    SMSDisambiguatePersonsCommandJSON(const SMSDisambiguatePersonsCommandJSON &);
    SMSDisambiguatePersonsCommandJSON & operator=(const SMSDisambiguatePersonsCommandJSON &other);
  ...
  public:
    SMSDisambiguatePersonsCommandJSON(void);
    virtual ~SMSDisambiguatePersonsCommandJSON(void);
    ...
    virtual size_t extraSMSDisambiguatePersonsCommandComponentCount(void) const
      {
        assert(extraKeys.size() == extraValues.size());
        return extraKeys.size();
      }
    virtual const char *extraSMSDisambiguatePersonsCommandComponentKey(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraKeys[component_num].c_str();
      }
    virtual JSONValue *extraSMSDisambiguatePersonsCommandComponentValue(size_t component_num)
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual const JSONValue *extraSMSDisambiguatePersonsCommandComponentValue(size_t component_num) const
      {
        assert(extraKeys.size() == extraValues.size());
        assert(component_num < extraValues.size());
        return extraValues[component_num];
      }
    virtual JSONValue *extraSMSDisambiguatePersonsCommandLookup(const char *field_name)
      {
        JSONValue *result = (JSONValue *)(lookup_in_string_index(extraIndex, field_name));
        if (result != NULL)
            result->add_reference();
    ...
    virtual const JSONValue *extraSMSDisambiguatePersonsCommandLookup(const char *field_name) const
      {
        JSONValue *result = (JSONValue *)(lookup_in_string_index(extraIndex, field_name));
        if (result != NULL)
            result->add_reference();
    ...
    virtual void extraSMSDisambiguatePersonsCommandAppendPair(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
        assert(new_component != NULL);
    ...
    virtual void extraSMSDisambiguatePersonsCommandSetField(const char *key, JSONValue *new_component)
      {
        assert(key != NULL);
        assert(new_component != NULL);
    ...
    static SMSDisambiguatePersonsCommandJSON *from_json(JSONValue *json_value, bool ignore_extras = false);
    static SMSDisambiguatePersonsCommandJSON *from_text(const char *text, bool ignore_extras = false)
      {
        SMSDisambiguatePersonsCommandJSON *result;
          {
            ...
            parse_json_value(text, "Text for SMSDisambiguatePersonsCommandJSON", &generator);
            assert(generator.have_value);
            result = generator.value.referenced();
            result->add_reference();
          };
    ...
    static SMSDisambiguatePersonsCommandJSON *from_file(FILE *fp, const char *file_name, bool ignore_extras = false)
      {
        SMSDisambiguatePersonsCommandJSON *result;
          {
            JSONHoldingGenerator<Generator, RCHandle<SMSDisambiguatePersonsCommandJSON>, SMSDisambiguatePersonsCommandJSON *, bool> generator("Type SMSDisambiguatePersonsCommand", ignore_extras);
    ...
    class Generator : public DisambiguateCommandJSON::Generator
      ...
      protected:
        ...
        void finish(void)
          {
            if (!(strcmp(getDisambiguateCommandJSONKey().c_str(), "SMSDisambiguatePersonsCommand") == 0))
                throw("The key field has a value other than `SMSDisambiguatePersonsCommand'.");
            SMSDisambiguatePersonsCommandJSON *result = new SMSDisambiguatePersonsCommandJSON();
            assert(result != NULL);
            RCHandle<SMSDisambiguatePersonsCommandJSON> result_holder = result;
            finish(result);
            size_t extra_count = unknownFieldGenerator.field_names.size();
            assert(extra_count == unknownFieldGenerator.field_values.size());
            for (size_t extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result->extraSMSDisambiguatePersonsCommandAppendPair(unknownFieldGenerator.field_names[extra_num].c_str(), unknownFieldGenerator.field_values[extra_num].referenced());
              }
            unknownFieldGenerator.field_names.clear();
            unknownFieldGenerator.field_values.clear();
            destroy_string_index(unknownFieldGenerator.index);
        ...
        void finish(SMSDisambiguatePersonsCommandJSON *result)
          {
        ...
        virtual void handle_result(SMSDisambiguatePersonsCommandJSON *new_result) = 0;
        virtual JSONHandler *start_known_field(const char *field_name)
          {
            if (strcmp(field_name, "NativeData") == 0)
      ...
      public:
        Generator(bool ignore_extras = false) : DisambiguateCommandJSON::Generator(ignore_extras), fieldGeneratorNativeData("field \"NativeData\" of the SMSDisambiguatePersonsCommand class", ignore_extras), unknownFieldGenerator(ignore_extras)
          {
...
#endif /* SMSDISAMBIGUATEPERSONSCOMMANDJSON_H */
