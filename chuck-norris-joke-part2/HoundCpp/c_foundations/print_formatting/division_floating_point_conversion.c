...
#define TEST_FOR_NAN(value, type) isnan(value)
#elif defined(_WIN32) || defined(_WIN64)
/* Microsoft doesn't define __STDC_VERSION__ because they don't claim to support
 * all of C90, but they do support isnam(). */
#define TEST_FOR_NAN(value, type) isnan(value)
#else
#define TEST_FOR_NAN(value, type) value == ((type)0.0) / ((type)0.0)
#endif
