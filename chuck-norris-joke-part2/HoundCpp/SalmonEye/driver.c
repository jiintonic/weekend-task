...
extern int run_salmon_source_file(const char *source_file_name, int argc,
        ...
        char *executable_directory)
  {
    ...
    the_verdict = bind_standard_built_ins_object(built_ins_object,
            the_unbound_name_manager, the_jumper);
    if (the_verdict != MISSION_ACCOMPLISHED)
      {
        delete_static_home(global_static_home);
        assert(!(object_is_closed(built_ins_object))); /* VERIFIED */
...
extern verdict bind_standard_built_ins_object(object *built_ins_object,
        unbound_name_manager *the_unbound_name_manager, jumper *the_jumper)
  {
...
extern context *global_object_internal_context(object *global_object,
                                               jumper *the_jumper)
  {
...
extern object *object_for_class_declaration(routine_declaration *declaration,
