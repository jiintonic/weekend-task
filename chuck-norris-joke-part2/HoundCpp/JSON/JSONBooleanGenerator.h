/* file "JSONBooleanGenerator.h" */

/* Copyright 2015 SoundHound, Incorporated.  All rights reserved. */

#ifndef JSONBOOLEANGENERATOR_H
#define JSONBOOLEANGENERATOR_H

#include "JSONCheckingHandler.h"


class JSONBooleanGenerator : public JSONCheckingHandler
  {
  protected:
    JSONBooleanGenerator(void);
    ~JSONBooleanGenerator(void);

    virtual void handle_result(bool result) = 0;
    virtual void validate(bool result)  { }
